...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react445.useCallback)((event) => {
    if (disabled) {
...
function useIsAfterInitialMount() {
  const [isAfterInitialMount, setIsAfterInitialMount] = (0, import_react446.useState)(false);
  (0, import_react446.useEffect)(() => {
...
function VisuallyHidden({
  ...
  return import_react447.default.createElement("span", {
...
function Spinner({
  ...
  const spinnerSVGMarkup = size === "large" ? import_react448.default.createElement("svg", {
    viewBox: "0 0 44 44",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react448.default.createElement("path", {
    d: "M15.542 1.487A21.507 21.507 0 00.5 22c0 11.874 9.626 21.5 21.5 21.5 9.847 0 18.364-6.675 20.809-16.072a1.5 1.5 0 00-2.904-.756C37.803 34.755 30.473 40.5 22 40.5 11.783 40.5 3.5 32.217 3.5 22c0-8.137 5.3-15.247 12.942-17.65a1.5 1.5 0 10-.9-2.863z"
  })) : import_react448.default.createElement("svg", {
    viewBox: "0 0 20 20",
    xmlns: "http://www.w3.org/2000/svg"
  }, import_react448.default.createElement("path", {
  ...
  const accessibilityLabelMarkup = (isAfterInitialMount || !hasFocusableParent) && import_react448.default.createElement(VisuallyHidden, null, accessibilityLabel);
  return import_react448.default.createElement(import_react448.default.Fragment, null, import_react448.default.createElement("span", {
    className
  }, spinnerSVGMarkup), import_react448.default.createElement("span", spanAttributes, accessibilityLabelMarkup));
}
...
function usePortalsManager() {
  const portalsManager = (0, import_react449.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function useUniqueId(prefix = "", overrideId = "") {
  const idFactory = (0, import_react450.useContext)(UniqueIdFactoryContext);
  const uniqueIdRef = (0, import_react450.useRef)(null);
  if (!idFactory) {
...
function Portal({
  ...
  return container ? (0, import_react_dom.createPortal)(import_react451.default.createElement("div", {
...
function wrapWithComponent(element, Component9, props) {
  ...
  return isElementOfType(element, Component9) ? element : import_react452.default.createElement(Component9, props, element);
}
...
function isElementOfType(element, Component9) {
  var _element$props;
  if (element == null || !(0, import_react452.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children2, predicate = () => true) {
  return import_react452.Children.toArray(children2).filter((child) => (0, import_react452.isValidElement)(child) && predicate(child));
}
...
function KeypressListener({
  ...
  const tracked = (0, import_react453.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react453.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
var ScrollableContext = (0, import_react454.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react455.useRef)(null);
  const scrollToPosition = (0, import_react455.useContext)(ScrollableContext);
  (0, import_react455.useEffect)(() => {
  ...
  return import_react455.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var Scrollable = class extends import_react456.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      topShadow: false,
  ...
  render() {
    ...
    return import_react456.default.createElement(ScrollableContext.Provider, {
      value: this.scrollToPosition
    }, import_react456.default.createElement(StickyManagerContext.Provider, {
      value: this.stickyManager
    }, import_react456.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react457.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
  ...
  render() {
    ...
    return import_react457.default.createElement("div", {
      className,
      style,
      ref: this.setOverlay
    }, import_react457.default.createElement(EventListener, {
      event: "resize",
...
function Section({
  ...
  return import_react458.default.createElement("div", {
...
function Pane({
  ...
  return fixed ? import_react459.default.createElement("div", {
    style,
    className
  }, content) : import_react459.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom
...
var PopoverOverlay = class extends import_react460.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = (0, import_react460.createRef)();
    ...
    this.renderPopover = (overlayDetails) => {
      ...
      const content = import_react460.default.createElement("div", {
        id,
      ...
      return import_react460.default.createElement("div", Object.assign({
        className
      }, overlay.props), import_react460.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), import_react460.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
      }), import_react460.default.createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: this.handleEscape
      }), import_react460.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
        onFocus: this.handleFocusFirstItem
      }), import_react460.default.createElement(CustomProperties, {
        colorScheme
      }, import_react460.default.createElement("div", {
        className: styles6.Wrapper
      }, content)), import_react460.default.createElement("div", {
        className: styles6.FocusTracker,
        tabIndex: 0,
    ...
    this.overlayRef = (0, import_react460.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return import_react460.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
function renderPopoverContent(children2, props) {
  const childrenArray = import_react460.Children.toArray(children2);
...
// node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = (0, import_react461.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react461.useState)();
  const overlayRef = (0, import_react461.useRef)(null);
  const activatorContainer = (0, import_react461.useRef)(null);
  ...
  (0, import_react461.useImperativeHandle)(ref, () => {
    return {
      forceUpdatePosition
    };
  });
  const setAccessibilityAttributes = (0, import_react461.useCallback)(() => {
  ...
  const portal2 = activatorNode ? import_react461.default.createElement(Portal, {
    idPrefix: "popover"
  }, import_react461.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
  ...
  return import_react461.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react461.Children.only(activator), portal2);
});
...
function TextStyle({
  ...
  return import_react462.default.createElement(Element2, {
    className
  }, children2);
}
...
var WithinFilterContext = (0, import_react463.createContext)(false);
...
function useI18n() {
  const i18n = (0, import_react464.useContext)(I18nContext);
  if (!i18n) {
...
function Pip({
  ...
  return import_react465.default.createElement("span", {
    className
  }, import_react465.default.createElement(VisuallyHidden, null, accessibilityLabel));
}
...
function Icon({
  ...
  const contentMarkup = {
    function: import_react466.default.createElement(SourceComponent, {
      className: styles13.Svg,
      focusable: "false",
      "aria-hidden": "true"
    }),
    placeholder: import_react466.default.createElement("div", {
      className: styles13.Placeholder
    }),
    external: import_react466.default.createElement("img", {
  ...
  return import_react466.default.createElement("span", {
    className
  }, import_react466.default.createElement(VisuallyHidden, null, accessibilityLabel), contentMarkup[sourceType]);
}
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react467.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && import_react467.default.createElement(VisuallyHidden, null, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = import_react467.default.createElement("span", {
      className: styles11.PipContainer
    }, import_react467.default.createElement(Pip, {
      progress,
      status,
      accessibilityLabelOverride: accessibilityLabel
    }));
  }
  return import_react467.default.createElement("span", {
    className
  }, accessibilityMarkup, icon && import_react467.default.createElement("span", {
    className: styles11.Icon
  }, import_react467.default.createElement(Icon, {
    source: icon
  })), children2 && import_react467.default.createElement("span", null, children2));
}
Badge.Pip = Pip;
...
function useLink() {
  return (0, import_react468.useContext)(LinkContext);
}

// node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = (0, import_react469.memo)((0, import_react469.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return import_react469.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props));
  }
  const {
    external,
    url,
  ...
  return import_react469.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function Item({
  ...
  if (prefix) {
    prefixMarkup = import_react470.default.createElement("span", {
      className: styles9.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react470.default.createElement("span", {
      className: styles9.Prefix
    }, import_react470.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react470.default.createElement("span", {
  ...
  const contentMarkup = helpText ? import_react470.default.createElement("span", {
    className: styles9.ContentBlock
  }, import_react470.default.createElement("span", {
    className: styles9.ContentBlockInner
  }, contentText), import_react470.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  const badgeMarkup = badge && import_react470.default.createElement("span", {
    className: styles9.Suffix
  }, import_react470.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react470.default.createElement("span", {
    className: styles9.Suffix
  }, suffix);
  const textMarkup = import_react470.default.createElement("span", {
    className: styles9.Text
  }, contentMarkup);
  const contentElement = import_react470.default.createElement("span", {
    className: styles9.Content
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const scrollMarkup = active ? import_react470.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? import_react470.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentElement) : import_react470.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return import_react470.default.createElement(import_react470.default.Fragment, null, scrollMarkup, control);
}
...
function Section2({
  ...
  const actionMarkup = section.items.map(({
    ...
    return import_react471.default.createElement("li", {
      key: `${content}-${index}`,
      role: actionRole === "menuitem" ? "presentation" : void 0
    }, import_react471.default.createElement(Item, Object.assign({
      content,
      helpText,
      role: actionRole,
  ...
  const titleMarkup = section.title ? import_react471.default.createElement("p", {
  ...
  const sectionMarkup = import_react471.default.createElement("div", {
    className
  }, titleMarkup, import_react471.default.createElement("ul", {
    className: styles9.Actions,
    role: sectionRole,
    tabIndex: !hasMultipleSections ? -1 : void 0
  }, actionMarkup));
  return hasMultipleSections ? import_react471.default.createElement("li", {
...
function ActionList({
  ...
  let finalSections = [];
  const actionListRef = (0, import_react472.useRef)(null);
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = finalSections.map((section, index) => {
    return section.items.length > 0 ? import_react472.default.createElement(Section2, {
  ...
  const listeners = actionRole === "menuitem" ? import_react472.default.createElement(import_react472.default.Fragment, null, import_react472.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), import_react472.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  return import_react472.default.createElement(Element2, {
    ref: actionListRef,
    className,
    role: elementRole,
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? import_react473.default.createElement("a", commonProps, children2) : import_react473.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      download
    }, rest), children2);
  } else {
    buttonMarkup = import_react473.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? import_react474.default.createElement("span", {
  ...
  }, import_react474.default.createElement(Icon, {
    source: loading ? "placeholder" : getDisclosureIconSource(disclosure)
  }))) : null;
  const iconSource = isIconSource(icon) ? import_react474.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? import_react474.default.createElement("span", {
    className: classNames(styles3.Icon, loading && styles3.hidden)
  }, iconSource) : null;
  const childMarkup = children2 ? import_react474.default.createElement("span", {
    className: classNames(styles3.Text, removeUnderline && styles3.removeUnderline),
    key: disabled ? "text-disabled" : "text"
  }, children2) : null;
  const spinnerSVGMarkup = loading ? import_react474.default.createElement("span", {
    className: styles3.Spinner
  }, import_react474.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })) : null;
  const [disclosureActive, setDisclosureActive] = (0, import_react474.useState)(false);
  const toggleDisclosureActive = (0, import_react474.useCallback)(() => {
  ...
  if (connectedDisclosure) {
    ...
    const connectedDisclosureActivator = import_react474.default.createElement("button", {
      type: "button",
    ...
    }, import_react474.default.createElement("span", {
      className: styles3.Icon
    }, import_react474.default.createElement(Icon, {
      source: SvgCaretDownMinor
    })));
    connectedDisclosureMarkup = import_react474.default.createElement(Popover2, {
      active: disclosureActive,
      onClose: toggleDisclosureActive,
      activator: connectedDisclosureActivator,
      preferredAlignment: "right"
    }, import_react474.default.createElement(ActionList, {
  ...
  const buttonMarkup = import_react474.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), import_react474.default.createElement("span", {
    className: styles3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup));
  return connectedDisclosureMarkup ? import_react474.default.createElement("div", {
...
function buttonFrom({
  ...
  return import_react475.default.createElement(Button, Object.assign({
    key,
    onClick: onAction
...
function ButtonGroup({
  ...
  const className = classNames(styles14.ButtonGroup, spacing && styles14[spacing], segmented && styles14.segmented, fullWidth && styles14.fullWidth);
  const contents = elementChildren(children2).map((child, index) => import_react477.default.createElement(Item2, {
    button: child,
    key: index
  }));
...
function Item3({
  ...
  return import_react478.default.createElement("div", {
    className
  }, children2);
}

// node_modules/@shopify/polaris/build/esm/components/Stack/Stack.js
var Stack = (0, import_react479.memo)(function Stack2({
  children: children2,
  vertical,
  spacing,
  distribution,
  ...
  const className = classNames(styles15.Stack, vertical && styles15.vertical, spacing && styles15[variationName("spacing", spacing)], distribution && styles15[variationName("distribution", distribution)], alignment && styles15[variationName("alignment", alignment)], wrap === false && styles15.noWrap);
  ...
  return import_react479.default.createElement("div", {
    className
  }, itemMarkup);
});
Stack.Item = Item3;
...
function Heading({
  ...
  return import_react480.default.createElement(Element2, {
...
function Header({
  ...
  const actionMarkup = actions ? import_react481.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = (0, import_react481.isValidElement)(title) ? title : import_react481.default.createElement(Heading, null, title);
  const headingMarkup = actionMarkup || children2 ? import_react481.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react481.default.createElement(Stack.Item, {
    fill: true
...
function Subheading({
  ...
  return import_react482.default.createElement(Element2, {
...
function Section3({
  ...
  const actionMarkup = actions ? import_react483.default.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  const titleMarkup = typeof title === "string" ? import_react483.default.createElement(Subheading, null, title) : title;
  const titleAreaMarkup = titleMarkup || actionMarkup ? import_react483.default.createElement("div", {
    className: styles2.SectionHeader
  }, actionMarkup ? import_react483.default.createElement(Stack, {
    alignment: "baseline"
  }, import_react483.default.createElement(Stack.Item, {
    fill: true
  }, titleMarkup), actionMarkup) : titleMarkup) : null;
  return import_react483.default.createElement("div", {
    className
...
var Card = function Card2({
  ...
  const headerMarkup = title || actions ? import_react485.default.createElement(Header, {
    actions,
    title
  }) : null;
  const content = sectioned ? import_react485.default.createElement(Section3, null, children2) : children2;
  ...
  if (secondaryFooterActions && secondaryFooterActions.length) {
    if (secondaryFooterActions.length === 1) {
      ...
      secondaryFooterActionsMarkup = import_react485.default.createElement(import_react485.default.Fragment, null, import_react485.default.createElement(Popover2, {
        active: secondaryActionsPopoverOpen,
        activator: import_react485.default.createElement(Button, {
          disclosure: true,
      ...
      }, import_react485.default.createElement(ActionList, {
        items: secondaryFooterActions
      })));
    }
  }
  const footerMarkup = primaryFooterActionMarkup || secondaryFooterActionsMarkup ? import_react485.default.createElement("div", {
    className: classNames(styles2.Footer, footerActionAlignment === "left" && styles2.LeftJustified)
  }, footerActionAlignment === "right" ? import_react485.default.createElement(ButtonGroup, null, secondaryFooterActionsMarkup, primaryFooterActionMarkup) : import_react485.default.createElement(ButtonGroup, null, primaryFooterActionMarkup, secondaryFooterActionsMarkup)) : null;
  return import_react485.default.createElement(WithinContentContext.Provider, {
    value: true
...
function SettingAction({
  ...
  return import_react486.default.createElement("div", {
    className: styles18.SettingAction
  }, import_react486.default.createElement("div", {
    className: styles18.Setting
  }, children2), import_react486.default.createElement("div", {
...
function Image({
  ...
  const handleLoad = (0, import_react487.useCallback)(() => {
    if (onLoad)
      onLoad();
  }, [onLoad]);
  return import_react487.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const [status, setStatus] = (0, import_react488.useState)(Status.Pending);
  (0, import_react488.useEffect)(() => {
    setStatus(Status.Pending);
  }, [source]);
  const handleError = (0, import_react488.useCallback)(() => {
    setStatus(Status.Errored);
    if (onError) {
      onError();
    }
  }, [onError]);
  const handleLoad = (0, import_react488.useCallback)(() => {
  ...
  const className = classNames(styles19.Avatar, size && styles19[variationName("size", size)], !customer && styles19[variationName("style", styleClass(nameString))], hasImage && status === Status.Loaded && styles19.imageHasLoaded, shape && styles19[variationName("shape", shape)]);
  const imageClassName = classNames(styles19.Image, status !== Status.Loaded && styles19.hidden);
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? import_react488.default.createElement(Image, {
  ...
  const avatarBody = customer || !initials ? import_react488.default.createElement("path", {
    fill: "currentColor",
  ...
  }) : import_react488.default.createElement("text", {
    x: "50%",
    y: "50%",
    dy: verticalOffset,
    fill: "currentColor",
  ...
  const svgMarkup = hasImage ? null : import_react488.default.createElement("span", {
    className: styles19.Initials
  }, import_react488.default.createElement("svg", {
    className: styles19.Svg,
    viewBox: "0 0 40 40"
  }, avatarBody));
  return import_react488.default.createElement("span", {
    "aria-label": label,
    role: "img",
    className
...
function AccountConnection({
  ...
  const avatarMarkup = connected ? import_react489.default.createElement(Avatar, {
    accessibilityLabel: "",
    name: accountName,
    initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = import_react489.default.createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = import_react489.default.createElement("div", null, accountName);
  }
  const detailsMarkup = details ? import_react489.default.createElement("div", null, import_react489.default.createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  const termsOfServiceMarkup = termsOfService ? import_react489.default.createElement("div", {
    className: styles.TermsOfService
  }, termsOfService) : null;
  const actionElement = action ? buttonFrom(action, {
    primary: !connected
  }) : null;
  return import_react489.default.createElement(Card, {
    sectioned: true
  }, import_react489.default.createElement(SettingAction, {
    action: actionElement
  }, import_react489.default.createElement(Stack, null, avatarMarkup, import_react489.default.createElement(Stack.Item, {
    fill: true
  }, import_react489.default.createElement("div", {
...
function RollupActions({
  ...
  const activatorMarkup = import_react490.default.createElement("div", {
    className: styles21.RollupActivator
  }, import_react490.default.createElement(Button, {
    outline: true,
  ...
  return import_react490.default.createElement(Popover2, {
    active: rollupOpen,
    activator: activatorMarkup,
    preferredAlignment: "right",
    onClose: toggleRollupOpen,
    hideOnPrint: true
  }, import_react490.default.createElement(ActionList, {
    items,
    sections,
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? import_react491.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    return import_react491.default.createElement("div", Object.assign({
      className: containerClassName
    }, layer.props), import_react491.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react492.useState)(null);
  const id = useUniqueId("TooltipContent");
  const activatorContainer = (0, import_react492.useRef)(null);
  const mouseEntered = (0, import_react492.useRef)(false);
  ...
  const handleKeyUp = (0, import_react492.useCallback)((event) => {
    if (event.keyCode !== Key.Escape)
      return;
    handleBlur();
  }, [handleBlur]);
  const portal2 = activatorNode ? import_react492.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, import_react492.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
    activator: activatorNode,
    active,
  ...
  return import_react492.default.createElement(WrapperComponent, {
    onFocus: handleFocus,
    onBlur: handleBlur,
...
function SecondaryAction({
  ...
  const secondaryActionsRef = (0, import_react493.useRef)(null);
  (0, import_react493.useEffect)(() => {
  ...
  const buttonMarkup = import_react493.default.createElement(Button, Object.assign({
    onClick: onAction
  }, rest), children2);
  const actionMarkup = helpText ? import_react493.default.createElement(Tooltip, {
    content: helpText
  }, buttonMarkup) : buttonMarkup;
  return import_react493.default.createElement("span", {
...
function MenuGroup({
  ...
  const handleClose = (0, import_react494.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react494.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  const handleClick = (0, import_react494.useCallback)(() => {
    if (onClick) {
      onClick(handleOpen);
    } else {
      handleOpen();
  ...
  const handleOffsetWidth = (0, import_react494.useCallback)((width) => {
    if (!getOffsetWidth)
      return;
    getOffsetWidth(width);
  }, [getOffsetWidth]);
  const popoverActivator = import_react494.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  return import_react494.default.createElement(Popover2, {
    active: Boolean(active),
    activator: popoverActivator,
    preferredAlignment: "left",
    onClose: handleClose,
    hideOnPrint: true
  }, import_react494.default.createElement(ActionList, {
    items: actions,
    sections,
    onActionAnyItem: handleClose
  }), details && import_react494.default.createElement("div", {
...
function Actions({
  ...
  const i18n = useI18n();
  const actionsLayoutRef = (0, import_react495.useRef)(null);
  const menuGroupWidthRef = (0, import_react495.useRef)(0);
  const availableWidthRef = (0, import_react495.useRef)(0);
  const actionsAndGroupsLengthRef = (0, import_react495.useRef)(0);
  const timesMeasured = (0, import_react495.useRef)(0);
  const actionWidthsRef = (0, import_react495.useRef)([]);
  const rollupActiveRef = (0, import_react495.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react495.useState)(void 0);
  const [measuredActions, setMeasuredActions] = (0, import_react495.useState)({
    showable: [],
    rolledUp: []
  });
  ...
  const handleActionsOffsetWidth = (0, import_react495.useCallback)((width) => {
    actionWidthsRef.current = [...actionWidthsRef.current, width];
  }, []);
  const handleMenuGroupToggle = (0, import_react495.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react495.useCallback)(() => setActiveMenuGroup(void 0), []);
  const updateActions = (0, import_react495.useCallback)(() => {
  ...
  const measureActions = (0, import_react495.useCallback)(() => {
  ...
  const handleResize = (0, import_react495.useMemo)(() => debounce(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return import_react495.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest, {
  ...
  const rollUppableActionsMarkup = measuredActions.showable.length > 0 ? measuredActions.showable.map((action) => action.content && import_react495.default.createElement(SecondaryAction, Object.assign({
    key: action.content
  }, action, {
    getOffsetWidth: handleActionsOffsetWidth
  }), action.content)) : null;
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup && !isLastMenuGroup) {
      return import_react495.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const groupedActionsMarkup = import_react495.default.createElement(ButtonGroup, {
    spacing: "extraTight"
  ...
  }, groupedActionsMarkup, import_react495.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }));
}
...
function ActionMenu({
  ...
  }, rollup ? import_react496.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : import_react496.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
var ComboboxTextFieldContext = (0, import_react497.createContext)(void 0);
var ComboboxListboxContext = (0, import_react497.createContext)({});
var ComboboxListboxOptionContext = (0, import_react497.createContext)({});

// node_modules/@shopify/polaris/build/esm/utilities/combobox/hooks.js
function useComboboxTextField() {
  const context = (0, import_react498.useContext)(ComboboxTextFieldContext);
  if (!context) {
...
function useComboboxListbox() {
  const context = (0, import_react498.useContext)(ComboboxListboxContext);
  return context;
}
...
var ListboxContext = (0, import_react499.createContext)(void 0);
var WithinListboxContext = (0, import_react499.createContext)(false);
var ActionContext = (0, import_react499.createContext)(false);
...
function Choice({
  ...
  const labelMarkup = import_react501.default.createElement("label", {
    className,
    htmlFor: id,
    onClick,
    onMouseOver,
    onMouseOut
  }, import_react501.default.createElement("span", {
    className: styles31.Control
  }, children2), import_react501.default.createElement("span", {
  ...
  const descriptionMarkup = helpTextMarkup || errorMarkup ? import_react501.default.createElement("div", {
    className: styles31.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? import_react501.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react502.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const inputNode = (0, import_react502.useRef)(null);
  ...
  const [keyFocused, setKeyFocused] = (0, import_react502.useState)(false);
  const isWithinListbox = (0, import_react502.useContext)(WithinListboxContext);
  (0, import_react502.useImperativeHandle)(ref, () => ({
    focus: () => {
  ...
  return import_react502.default.createElement(Choice, {
    id,
    label,
    labelHidden,
    helpText,
  ...
  }, import_react502.default.createElement("span", {
    className: wrapperClassName
  }, import_react502.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), import_react502.default.createElement("span", {
    className: backdropClassName,
    onClick: stopPropagation,
    onKeyUp: stopPropagation
  }), import_react502.default.createElement("span", {
    className: styles30.Icon
  }, import_react502.default.createElement(Icon, {
    source: iconSource
  }))));
});
function noop4() {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/TextOption/TextOption.js
var TextOption = (0, import_react503.memo)(function TextOption2({
  children: children2,
  selected,
  disabled
}) {
  const {
    allowMultiple
  } = (0, import_react503.useContext)(ComboboxListboxOptionContext);
  const isAction = (0, import_react503.useContext)(ActionContext);
  ...
  }, allowMultiple && !isAction ? import_react503.default.createElement("div", {
    className: styles29.Checkbox
  }, import_react503.default.createElement(Checkbox, {
    disabled,
    checked: selected,
    label: children2
  })) : children2));
...
function useListbox() {
  const listbox = (0, import_react504.useContext)(ListboxContext);
  if (!listbox) {
...
// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Loading/Loading.js
var Loading = (0, import_react505.memo)(function LoadingOption({
  children: children2,
  ...
  return import_react505.default.createElement("li", {
    className: styles33.ListItem,
    role: "presentation"
  }, children2 ? children2 : import_react505.default.createElement("div", {
    className: styles33.Loading
  }, import_react505.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: label
  })));
});
...
var SectionContext = (0, import_react506.createContext)(null);
...
function Section4({
  ...
  return import_react507.default.createElement(SectionContext.Provider, {
    value: sectionId
  }, import_react507.default.createElement("li", Object.assign({
    role: "presentation"
  }, listboxSectionDataSelector.props), title, import_react507.default.createElement("ul", {
    role: "group",
...
function useSection() {
  const context = (0, import_react508.useContext)(SectionContext);
  return context;
}
...
function Header2({
  ...
  const content = typeof children2 === "string" ? import_react509.default.createElement("div", {
...
var MappedActionContext = (0, import_react510.createContext)({});

// node_modules/@shopify/polaris/build/esm/components/Listbox/components/Option/Option.js
var Option = (0, import_react511.memo)(function Option2({
  value,
  children: children2,
  selected,
  disabled = false,
  ...
  const isAction = (0, import_react511.useContext)(ActionContext);
  const {
    role,
    url,
    external,
    onAction,
    destructive
  } = (0, import_react511.useContext)(MappedActionContext);
  const listItemRef = (0, import_react511.useRef)(null);
  const domId = useUniqueId("ListboxOption");
  const sectionId = useSection();
  const isWithinSection = Boolean(sectionId);
  const handleOptionSelect = (0, import_react511.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    onAction && onAction();
  ...
  const content = typeof children2 === "string" ? import_react511.default.createElement(TextOption, {
    selected,
    disabled
  }, children2) : children2;
  ...
  const contentMarkup = url ? import_react511.default.createElement(UnstyledLink, {
    url,
    external
  }, content) : content;
  return import_react511.default.createElement("li", Object.assign({}, sectionAttributes, {
...
function Action(props) {
  ...
  const iconMarkup = icon && import_react512.default.createElement("div", {
  ...
  return import_react512.default.createElement(ActionContext.Provider, {
    value: true
  }, import_react512.default.createElement(Option, props, import_react512.default.createElement("div", {
    className
  }, import_react512.default.createElement(TextOption, {
    selected,
    disabled
...
function Listbox({
  ...
  const [loading, setLoading] = (0, import_react513.useState)();
  const [activeOption, setActiveOption] = (0, import_react513.useState)();
  const [lazyLoading, setLazyLoading] = (0, import_react513.useState)(false);
  const [currentOptions, setCurrentOptions] = (0, import_react513.useState)([]);
  const {
  ...
  const scrollableRef = (0, import_react513.useRef)(null);
  const listboxRef = (0, import_react513.useRef)(null);
  const {
    listboxId,
    textFieldLabelId,
    textFieldFocused,
  ...
  (0, import_react513.useEffect)(() => {
    if (setListboxId && !listboxId) {
      setListboxId(listId);
    }
  }, [setListboxId, listboxId, listId]);
  const getNavigableOptions = (0, import_react513.useCallback)(() => {
    if (!listboxRef.current) {
      return [];
    }
    return [...new Set(listboxRef.current.querySelectorAll(OPTION_SELECTOR))];
  }, []);
  const getFirstNavigableOption = (0, import_react513.useCallback)((currentOptions2) => {
  ...
  const handleScrollIntoView = (0, import_react513.useCallback)((option) => {
    const {
      current: scrollable2
    } = scrollableRef;
    if (scrollable2) {
  ...
  const handleKeyToBottom = (0, import_react513.useCallback)(() => {
    if (onKeyToBottom) {
      setLazyLoading(true);
      return Promise.resolve(onKeyToBottom());
    }
  }, [onKeyToBottom]);
  const handleChangeActiveOption = (0, import_react513.useCallback)((nextOption) => {
    if (!nextOption)
  ...
  const getFormattedOption = (0, import_react513.useCallback)((element, index) => {
    return {
      element,
      index,
      domId: element.id,
  ...
  const resetActiveOption = (0, import_react513.useCallback)(() => {
  ...
  (0, import_react513.useEffect)(() => {
    if (autoSelection !== AutoSelection.None && !loading && children2 && import_react513.Children.count(children2) > 0) {
      resetActiveOption();
    }
  ...
  const onOptionSelect = (0, import_react513.useCallback)((option) => {
  ...
  const getNextIndex = (0, import_react513.useCallback)((currentIndex, lastIndex, direction) => {
    let nextIndex;
    if (direction === "down") {
  ...
  const getNextValidOption = (0, import_react513.useCallback)(async (key) => {
  ...
  const handleArrow = (0, import_react513.useCallback)(async (type, event) => {
    event.preventDefault();
    const {
      element,
      nextIndex
  ...
  const handleDownArrow = (0, import_react513.useCallback)((event) => {
    handleArrow("down", event);
  }, [handleArrow]);
  const handleUpArrow = (0, import_react513.useCallback)((event) => {
    handleArrow("up", event);
  }, [handleArrow]);
  const handleEnter = (0, import_react513.useCallback)((event) => {
    event.preventDefault();
    event.stopPropagation();
    if (activeOption) {
  ...
  const handleFocus = (0, import_react513.useCallback)(() => {
    if (enableKeyboardControl)
      return;
    enableKeyboardEvents();
  }, [enableKeyboardControl, enableKeyboardEvents]);
  const handleBlur = (0, import_react513.useCallback)((event) => {
    event.stopPropagation();
  ...
  const listeners = keyboardEventsEnabled || textFieldFocused ? import_react513.default.createElement(import_react513.default.Fragment, null, import_react513.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleDownArrow
  }), import_react513.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
  ...
  const listboxContext = (0, import_react513.useMemo)(() => ({
    onOptionSelect,
    setLoading
  }), [onOptionSelect]);
  return import_react513.default.createElement(import_react513.default.Fragment, null, listeners, import_react513.default.createElement(VisuallyHidden, null, import_react513.default.createElement("div", {
    "aria-live": "polite"
  }, loading ? loading : null)), import_react513.default.createElement(ListboxContext.Provider, {
    value: listboxContext
  }, import_react513.default.createElement(WithinListboxContext.Provider, {
    value: true
  }, children2 ? import_react513.default.createElement("ul", {
    tabIndex: 0,
    role: "listbox",
...
// node_modules/@shopify/polaris/build/esm/components/Autocomplete/components/MappedOption/MappedOption.js
var MappedOption = (0, import_react514.memo)(function MappedOption2({
  label,
  value,
  disabled,
  media,
  ...
  const mediaMarkup = media ? import_react514.default.createElement("div", {
    className: mediaClassNames
  }, media) : null;
  const accessibilityLabel = typeof label === "string" ? label : void 0;
  return import_react514.default.createElement(Listbox.Option, {
    accessibilityLabel,
    key: value,
    selected,
    value,
    disabled
  }, import_react514.default.createElement(Listbox.TextOption, {
    selected,
    disabled
...
var Spinner2 = import_react515.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp
  ...
  return import_react515.default.createElement("div", {
    className: styles39.Spinner,
    onClick,
    "aria-hidden": true,
    ref
  }, import_react515.default.createElement("div", {
    role: "button",
  ...
  }, import_react515.default.createElement(Icon, {
...
function Label({
  ...
  return import_react516.default.createElement("div", {
    className
  }, import_react516.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function Labelled({
  ...
  const actionMarkup = action ? import_react517.default.createElement("div", {
    className: styles40.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  const helpTextMarkup = helpText ? import_react517.default.createElement("div", {
    className: styles40.HelpText,
    id: helpTextID2(id)
  }, helpText) : null;
  const errorMarkup = error && typeof error !== "boolean" && import_react517.default.createElement("div", {
    className: styles40.Error
  }, import_react517.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? import_react517.default.createElement("div", {
    className: styles40.LabelWrapper
  }, import_react517.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function Item4({
  ...
  return import_react518.default.createElement("div", {
    onBlur: forceFalseFocused,
    onFocus: forceTrueFocused,
    className
  }, children2);
...
function Connected({
  ...
  const leftConnectionMarkup = left ? import_react519.default.createElement(Item4, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? import_react519.default.createElement(Item4, {
    position: "right"
  }, right) : null;
  return import_react519.default.createElement("div", {
    className: styles42.Connected
  }, leftConnectionMarkup, import_react519.default.createElement(Item4, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react520.useRef)(null);
  const minimumLinesNode = (0, import_react520.useRef)(null);
  const animationFrame = (0, import_react520.useRef)();
  const currentHeight = (0, import_react520.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? import_react520.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react520.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  return import_react520.default.createElement("div", {
    "aria-hidden": true,
    className: styles39.Resizer
  }, import_react520.default.createElement(EventListener, {
    event: "resize",
    handler: handleHeightCheck
  }), import_react520.default.createElement("div", {
    ref: contentNode,
    className: styles39.DummyInput,
    dangerouslySetInnerHTML: {
...
function TextField({
  ...
  const i18n = useI18n();
  const [height, setHeight] = (0, import_react521.useState)(null);
  const [focus, setFocus] = (0, import_react521.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const id = useUniqueId("TextField", idProp);
  const inputRef = (0, import_react521.useRef)(null);
  const textAreaRef = (0, import_react521.useRef)(null);
  const prefixRef = (0, import_react521.useRef)(null);
  const suffixRef = (0, import_react521.useRef)(null);
  const verticalContentRef = (0, import_react521.useRef)(null);
  const buttonPressTimer = (0, import_react521.useRef)();
  const spinnerRef = (0, import_react521.useRef)(null);
  (0, import_react521.useEffect)(() => {
  ...
  const prefixMarkup = prefix ? import_react521.default.createElement("div", {
    className: styles39.Prefix,
    id: `${id}-Prefix`,
    ref: prefixRef
  }, prefix) : null;
  const suffixMarkup = suffix ? import_react521.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = import_react521.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? import_react521.default.createElement("button", {
    type: "button",
    className: styles39.ClearButton,
    onClick: handleClearButtonPress,
    disabled
  }, import_react521.default.createElement(VisuallyHidden, null, i18n.translate("Polaris.Common.clear")), import_react521.default.createElement(Icon, {
    source: SvgCircleCancelMinor,
    color: "base"
  })) : null;
  const handleNumberChange = (0, import_react521.useCallback)((steps) => {
    if (onChange == null) {
      return;
    }
  ...
  const handleButtonRelease = (0, import_react521.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleButtonPress = (0, import_react521.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = type === "number" && step !== 0 && !disabled && !readOnly ? import_react521.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react521.useCallback)((height2) => {
    setHeight(height2);
  }, []);
  const resizer = multiline && isAfterInitial ? import_react521.default.createElement(Resizer, {
  ...
  const input = (0, import_react521.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? import_react521.default.createElement("div", {
  ...
  const backdropMarkup = import_react521.default.createElement("div", {
  ...
  return import_react521.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    helpText,
    requiredIndicator
  }, import_react521.default.createElement(Connected, {
    left: connectedLeft,
    right: connectedRight
  }, import_react521.default.createElement("div", {
    className,
    onClick: handleClick
...
function TextField2({
  ...
  const textFieldId = (0, import_react522.useMemo)(() => idProp || uniqueId, [uniqueId, idProp]);
  const labelId = (0, import_react522.useMemo)(() => labelID(idProp || uniqueId), [uniqueId, idProp]);
  (0, import_react522.useEffect)(() => {
    if (setTextFieldLabelId)
      setTextFieldLabelId(labelId);
  }, [labelId, setTextFieldLabelId]);
  const handleFocus = (0, import_react522.useCallback)((event) => {
    if (onFocus)
      onFocus(event);
    if (onTextFieldFocus)
      onTextFieldFocus();
  ...
  const handleBlur = (0, import_react522.useCallback)((event) => {
    if (onBlur)
      onBlur(event);
    if (onTextFieldBlur)
      onTextFieldBlur();
  ...
  const handleChange = (0, import_react522.useCallback)((value2, id) => {
    if (onChange)
      onChange(value2, id);
    if (onTextFieldChange)
      onTextFieldChange(value2);
  }, [onChange, onTextFieldChange]);
  return import_react522.default.createElement(TextField, Object.assign({}, rest, {
    value,
    id: textFieldId,
    type,
    ariaAutocomplete,
...
function Combobox({
  ...
  const [popoverActive, setPopoverActive] = (0, import_react523.useState)(false);
  const [activeOptionId, setActiveOptionId] = (0, import_react523.useState)();
  const [textFieldLabelId, setTextFieldLabelId] = (0, import_react523.useState)();
  const [listboxId, setListboxId] = (0, import_react523.useState)();
  const [textFieldFocused, setTextFieldFocused] = (0, import_react523.useState)(false);
  const shouldOpen = Boolean(!popoverActive && import_react523.Children.count(children2) > 0);
  const ref = (0, import_react523.useRef)(null);
  const handleClose = (0, import_react523.useCallback)(() => {
    setPopoverActive(false);
    onClose === null || onClose === void 0 ? void 0 : onClose();
    setActiveOptionId(void 0);
  }, [onClose]);
  const handleOpen = (0, import_react523.useCallback)(() => {
    setPopoverActive(true);
    setActiveOptionId(void 0);
  }, []);
  const onOptionSelected = (0, import_react523.useCallback)(() => {
    var _ref$current;
    if (!allowMultiple) {
      handleClose();
      setActiveOptionId(void 0);
  ...
  const handleFocus = (0, import_react523.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleChange = (0, import_react523.useCallback)(() => {
    if (shouldOpen) {
      handleOpen();
    }
  }, [shouldOpen, handleOpen]);
  const handleBlur = (0, import_react523.useCallback)(() => {
    if (popoverActive) {
      handleClose();
    }
  }, [popoverActive, handleClose]);
  const textFieldContextValue = (0, import_react523.useMemo)(() => ({
    activeOptionId,
  ...
  const listboxOptionContextValue = (0, import_react523.useMemo)(() => ({
    allowMultiple
  }), [allowMultiple]);
  const listboxContextValue = (0, import_react523.useMemo)(() => ({
    listboxId,
    textFieldLabelId,
    textFieldFocused,
    willLoadMoreOptions,
  ...
  return import_react523.default.createElement(Popover2, {
    ref,
    active: popoverActive,
    activator: import_react523.default.createElement(ComboboxTextFieldContext.Provider, {
    ...
    preferredPosition,
    onClose: handleClose
  }, import_react523.Children.count(children2) > 0 ? import_react523.default.createElement(Popover2.Pane, {
    onScrolledToBottom,
    height
  }, import_react523.default.createElement(ComboboxListboxContext.Provider, {
    value: listboxContextValue
  }, import_react523.default.createElement(ComboboxListboxOptionContext.Provider, {
    value: listboxOptionContextValue
  }, import_react523.default.createElement("div", {
...
function MappedAction({
  ...
  if (prefix) {
    prefixMarkup = import_react524.default.createElement("div", {
      className: styles43.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = import_react524.default.createElement("div", {
      className: styles43.Prefix
    }, import_react524.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = import_react524.default.createElement("div", {
  ...
  const badgeMarkup = badge && import_react524.default.createElement("span", {
    className: styles43.Suffix
  }, import_react524.default.createElement(Badge, {
    status: badge.status
  }, badge.content));
  const suffixMarkup = suffix && import_react524.default.createElement("span", {
    className: styles43.Suffix
  }, suffix);
  const contentText = ellipsis && content ? i18n.translate("Polaris.Autocomplete.ellipsis", {
    content
  }) : content;
  const contentMarkup = import_react524.default.createElement("div", {
    className: styles43.Text
  }, import_react524.default.createElement("div", {
    className: contentOverflowStyle
  }, contentText), helpText ? import_react524.default.createElement(TextStyle, {
    variation: "subdued"
  }, helpText) : null);
  const context = (0, import_react524.useMemo)(() => ({
    role,
    url,
    external,
    onAction,
  ...
  return import_react524.default.createElement(MappedActionContext.Provider, {
    value: context
  }, import_react524.default.createElement("div", {
    className: styles43.ActionContainer
  }, import_react524.default.createElement(Listbox.Action, {
    selected: active,
    disabled,
    value: content || ""
  }, import_react524.default.createElement("div", {
...
var Autocomplete = function Autocomplete2({
  ...
  const i18n = useI18n();
  const buildMappedOptionFromOption = (0, import_react525.useCallback)((options2) => {
    return options2.map((option) => import_react525.default.createElement(MappedOption, Object.assign({
  ...
  const optionsMarkup = (0, import_react525.useMemo)(() => {
    ...
    if (isSection(conditionalOptions)) {
      ...
      const optionsMarkup2 = conditionalOptions.map(({
        ...
        return import_react525.default.createElement(Listbox.Section, {
          divider: false,
          title: import_react525.default.createElement(Listbox.Header, null, title),
          key: title
        }, optionMarkup);
      });
      return import_react525.default.createElement("div", {
    ...
    if (listTitle) {
      return import_react525.default.createElement(Listbox.Section, {
        divider: false,
        title: import_react525.default.createElement(Listbox.Header, null, listTitle)
      }, optionList);
    }
    return optionList;
  }, [listTitle, loading, options, willLoadMoreResults, buildMappedOptionFromOption]);
  const loadingMarkup = loading ? import_react525.default.createElement(Listbox.Loading, {
    accessibilityLabel: i18n.translate("Polaris.Autocomplete.spinnerAccessibilityLabel")
  }) : null;
  const updateSelection = (0, import_react525.useCallback)((newSelection) => {
  ...
  const actionMarkup = actionBefore && import_react525.default.createElement(MappedAction, actionBefore);
  const emptyStateMarkup = emptyState && options.length < 1 && !loading && import_react525.default.createElement("div", {
    role: "status"
  }, emptyState);
  const autoSelection = actionBefore ? AutoSelection.First : void 0;
  return import_react525.default.createElement(Combobox, {
    activator: textField,
    allowMultiple,
    onScrolledToBottom: onLoadMoreResults,
    preferredPosition,
    willLoadMoreOptions: willLoadMoreResults
  }, actionMarkup || optionsMarkup || loadingMarkup || emptyStateMarkup ? import_react525.default.createElement(Listbox, {
    autoSelection,
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react526.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return import_react528.default.createElement(import_react528.default.Fragment, null, import_react528.default.createElement(ScrollLock, null), import_react528.default.createElement("div", {
    className,
    onClick,
    onTouchStart
  }));
...
var BannerContext = (0, import_react529.createContext)(false);
...
function unstyledButtonFrom({
  ...
  return import_react530.default.createElement(UnstyledButton, Object.assign({
    key,
    onClick: onAction
  }, action, overrides), content);
}
...
// node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = (0, import_react531.forwardRef)(function Banner2({
  icon,
  action,
  secondaryAction,
  title,
  ...
  const withinContentContainer = (0, import_react531.useContext)(WithinContentContext);
  ...
  if (title) {
    ...
    headingMarkup = import_react531.default.createElement("div", {
      className: styles45.Heading,
      id: headingID
    }, import_react531.default.createElement(Heading, {
      element: "p"
    }, title));
  }
  const spinnerMarkup = action !== null && action !== void 0 && action.loading ? import_react531.default.createElement("button", {
    disabled: true,
    "aria-busy": true,
  ...
  }, import_react531.default.createElement(Spinner, {
    size: "small",
    accessibilityLabel: i18n.translate("Polaris.Button.spinnerAccessibilityLabel")
  })), action.content) : null;
  const primaryActionMarkup = action ? import_react531.default.createElement("div", {
    className: styles45.PrimaryAction
  }, action.loading ? spinnerMarkup : unstyledButtonFrom(action, {
    className: styles45.Button
  })) : null;
  const secondaryActionMarkup = secondaryAction ? import_react531.default.createElement(SecondaryActionFrom, {
    action: secondaryAction
  }) : null;
  const actionMarkup = action || secondaryAction ? import_react531.default.createElement("div", {
    className: styles45.Actions
  }, import_react531.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  let contentMarkup = null;
  let contentID;
  if (children2 || actionMarkup) {
    contentID = `${id}Content`;
    contentMarkup = import_react531.default.createElement("div", {
      className: styles45.Content,
      id: contentID
    }, children2, actionMarkup);
  }
  const dismissButton = onDismiss && import_react531.default.createElement("div", {
    className: styles45.Dismiss
  }, import_react531.default.createElement(Button, {
    plain: true,
    icon: SvgCancelSmallMinor,
    onClick: onDismiss,
    accessibilityLabel: "Dismiss notification"
  }));
  return import_react531.default.createElement(BannerContext.Provider, {
    value: true
  ...
  }, dismissButton, import_react531.default.createElement("div", {
    className: styles45.Ribbon
  }, import_react531.default.createElement(Icon, {
    source: iconName,
    color: iconColor
  })), import_react531.default.createElement("div", {
...
function SecondaryActionFrom({
  ...
  if (action.url) {
    return import_react531.default.createElement(UnstyledLink, {
  ...
  return import_react531.default.createElement(UnstyledButton, {
    className: styles45.SecondaryAction,
...
function useBannerFocus(bannerRef) {
  const wrapperRef = (0, import_react531.useRef)(null);
  const [shouldShowFocus, setShouldShowFocus] = (0, import_react531.useState)(false);
  (0, import_react531.useImperativeHandle)(bannerRef, () => ({
    focus: () => {
...
function Breadcrumbs({
  ...
  const contentMarkup = import_react532.default.createElement(import_react532.default.Fragment, null, import_react532.default.createElement("span", {
    className: styles46.Icon
  }, import_react532.default.createElement(Icon, {
    source: SvgArrowLeftMinor
  })), import_react532.default.createElement(VisuallyHidden, null, content));
  const breadcrumbMarkup = "url" in breadcrumb ? import_react532.default.createElement(UnstyledLink, {
    key: content,
    url: breadcrumb.url,
    className: styles46.Breadcrumb,
    onMouseUp: handleMouseUpByBlurring,
    "aria-label": breadcrumb.accessibilityLabel
  }, contentMarkup) : import_react532.default.createElement("button", {
    key: content,
    className: styles46.Breadcrumb,
  ...
  return import_react532.default.createElement("nav", {
    role: "navigation"
  }, breadcrumbMarkup);
}
...
var TransitionGroupContext_default = import_react533.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react534.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react534.default.cloneElement(import_react534.default.Children.only(children2), childProps));
  };
  return Transition2;
}(import_react534.default.Component);
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react535.default.createElement(Transition_default, _extends({}, props, {
...
}(import_react535.default.Component);
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react536.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react536.Children.map(children2, function(c) {
      return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function(child) {
    return (0, import_react536.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (!(0, import_react536.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react536.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react536.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react536.isValidElement)(prevChild)) {
      children2[key] = (0, import_react536.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component9 === null) {
      return import_react537.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children2);
    }
    return import_react537.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react537.default.createElement(Component9, props, children2));
  };
  return TransitionGroup2;
}(import_react537.default.Component);
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react538.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react538.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react538.default.createElement(TransitionGroup_default, props, inProp ? import_react538.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react538.default.cloneElement(second, {
      key: "second",
...
}(import_react538.default.Component);
ReplaceTransition.propTypes = true ? {
  in: import_prop_types5.default.bool.isRequired,
  children: function children(props, propName) {
    if (import_react538.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react539.default.isValidElement(oldChildren) && import_react539.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react539.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react539.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react539.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react539.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react539.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react539.default.cloneElement(props.children, {
        in: true
      })
    };
  };
  _proto.render = function render() {
    ...
    return import_react539.default.createElement(TransitionGroupContext_default.Provider, {
      value: {
...
}(import_react539.default.Component);
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react540.useRef)(false);
...
function Indicator({
  ...
  return import_react541.default.createElement("span", {
    className
  });
}
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react542.useRef)(null);
  ...
  return import_react542.default.createElement("div", {
    ...
    disabled,
    disclosure
  }, content), indicator && import_react542.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return import_react543.default.createElement(import_react543.default.Fragment, null, import_react543.default.createElement(Popover2, {
    active: isVisible,
    activator: import_react543.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, import_react543.default.createElement(ActionList, {
    items: actions,
...
var ResourceListContext = (0, import_react544.createContext)({});
...
function CheckableButton({
  ...
  const checkBoxRef = (0, import_react545.useRef)(null);
  const {
    registerCheckableButtons
  } = (0, import_react545.useContext)(ResourceListContext);
  ...
  return import_react545.default.createElement("div", {
    className,
    onClick: onToggleAll
  }, import_react545.default.createElement("div", {
    className: styles49.Checkbox
  }, import_react545.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
...
var BulkActionsInner = class extends import_react546.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.checkableWrapperNode = (0, import_react546.createRef)();
    this.largeScreenGroupNode = (0, import_react546.createRef)();
    this.smallScreenGroupNode = (0, import_react546.createRef)();
  ...
  render() {
    ...
    const paginatedSelectAllActionMarkup = paginatedSelectAllAction ? import_react546.default.createElement(Button, {
      onClick: paginatedSelectAllAction.onAction,
      plain: true,
      disabled
    }, paginatedSelectAllAction.content) : null;
    const paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? import_react546.default.createElement("span", {
      "aria-live": "polite"
    }, paginatedSelectAllText) : paginatedSelectAllText;
    const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? import_react546.default.createElement("div", {
      className: styles47.PaginatedSelectAll
    }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
    const cancelButton = import_react546.default.createElement(Button, {
      onClick: this.setSelectMode.bind(this, false),
      disabled
    }, i18n.translate("Polaris.Common.cancel"));
    const numberOfPromotedActionsToRender = this.numberOfPromotedActionsToRender();
    const allActionsPopover = this.hasActions() ? import_react546.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react546.default.createElement(Popover2, {
      active: smallScreenPopoverVisible,
      activator: import_react546.default.createElement(BulkActionButton, {
        disclosure: true,
    ...
    }, import_react546.default.createElement(ActionList, {
    ...
    const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? [...promotedActions].slice(0, numberOfPromotedActionsToRender).map((action, index) => {
      if (instanceOfMenuGroupDescriptor(action)) {
        return import_react546.default.createElement(BulkActionMenu, Object.assign({
          key: index
        }, action, {
          isNewBadgeInBadgeActions: this.isNewBadgeInBadgeActions()
        }));
      }
      return import_react546.default.createElement(BulkActionButton, Object.assign({
        key: index,
        disabled
      }, action, {
    ...
    const actionsPopover = actionSections || rolledInPromotedActions.length > 0 || measuring ? import_react546.default.createElement("div", {
      className: styles47.Popover,
      ref: this.setMoreActionsNode
    }, import_react546.default.createElement(Popover2, {
    ...
    const smallScreenGroup = smallScreen ? import_react546.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "smallGroup",
      ...
      }, import_react546.default.createElement("div", {
        className: styles47.ButtonGroupWrapper
      }, import_react546.default.createElement(ButtonGroup, {
        segmented: true
      }, import_react546.default.createElement(CSSTransition_default, {
      ...
      }, import_react546.default.createElement(CheckableButton, Object.assign({}, checkableButtonProps, {
        smallScreen: true
      })))), allActionsPopover, cancelButton)), paginatedSelectAllMarkup);
    }) : null;
    const largeGroupContent = promotedActionsMarkup || actionsPopover ? import_react546.default.createElement(ButtonGroup, {
      segmented: true
    }, import_react546.default.createElement(CheckableButton, checkableButtonProps), promotedActionsMarkup, actionsPopover) : import_react546.default.createElement(CheckableButton, checkableButtonProps);
    const largeScreenGroup = smallScreen ? null : import_react546.default.createElement(Transition_default, {
      timeout: 0,
      in: selectMode,
      key: "largeGroup",
      ...
      }, import_react546.default.createElement(EventListener, {
        event: "resize",
...
function BulkActions(props) {
  const i18n = useI18n();
  return import_react546.default.createElement(BulkActionsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function CalloutCard({
  ...
  const buttonMarkup = secondaryActionMarkup ? import_react548.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  const dismissButton = onDismiss ? import_react548.default.createElement("div", {
  ...
  return import_react548.default.createElement(Card, null, import_react548.default.createElement("div", {
    className: containerClassName
  }, dismissButton, import_react548.default.createElement(Card.Section, null, import_react548.default.createElement("div", {
    className: styles50.CalloutCard
  }, import_react548.default.createElement("div", {
    className: styles50.Content
  }, import_react548.default.createElement("div", {
    className: styles50.Title
  }, import_react548.default.createElement(Heading, null, title)), import_react548.default.createElement(TextContainer, null, children2), import_react548.default.createElement("div", {
    className: styles50.Buttons
  }, buttonMarkup)), import_react548.default.createElement(Image, {
    alt: "",
    className: imageClassName,
    source: illustration
  })))));
...
function Caption({
  ...
  return import_react549.default.createElement("p", {
...
function RadioButton({
  ...
  const inputNode = (0, import_react550.useRef)(null);
  const [keyFocused, setKeyFocused] = (0, import_react550.useState)(false);
  const {
    value: mouseOver,
    setTrue: handleMouseOver,
    setFalse: handleMouseOut
  ...
  return import_react550.default.createElement(Choice, {
    label,
    labelHidden,
    disabled,
    id,
    ...
    onMouseOver: handleMouseOver,
    onMouseOut: handleMouseOut
  }, import_react550.default.createElement("span", {
    className: styles54.RadioButton
  }, import_react550.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const titleMarkup = title ? import_react551.default.createElement("legend", {
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children2 = renderedChildren ? import_react551.default.createElement("div", {
      className: styles53.ChoiceChildren
    }, renderedChildren) : null;
    return import_react551.default.createElement("li", {
      key: value,
      className: styles53.ChoiceItem
    }, import_react551.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && import_react551.default.createElement("div", {
    className: styles53.ChoiceError
  }, import_react551.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return import_react551.default.createElement("fieldset", {
    className,
    id: finalName,
    "aria-invalid": error != null
  }, titleMarkup, import_react551.default.createElement("ul", {
...
function Collapsible({
  ...
  const [height, setHeight] = (0, import_react552.useState)(0);
  const [isOpen, setIsOpen] = (0, import_react552.useState)(open);
  const [animationState, setAnimationState] = (0, import_react552.useState)("idle");
  const collapsibleContainer = (0, import_react552.useRef)(null);
  ...
  const handleCompleteAnimation = (0, import_react552.useCallback)(({
    target
  }) => {
...
var Slidable = class extends import_react553.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      dragging: false
  ...
  render() {
    ...
    const moveListener = dragging ? import_react553.default.createElement(EventListener, {
      event: "mousemove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const touchMoveListener = dragging ? import_react553.default.createElement(EventListener, {
      event: "touchmove",
      handler: this.handleMove,
      passive: false
    }) : null;
    const endDragListener = dragging ? import_react553.default.createElement(EventListener, {
      event: "mouseup",
      handler: this.handleDragEnd
    }) : null;
    const touchEndListener = dragging ? import_react553.default.createElement(EventListener, {
      event: "touchend",
      handler: this.handleDragEnd
    }) : null;
    const touchCancelListener = dragging ? import_react553.default.createElement(EventListener, {
      event: "touchcancel",
      handler: this.handleDragEnd
    }) : null;
    return import_react553.default.createElement("div", {
      ref: this.setNode,
      className: styles56.Slidable,
      onMouseDown: this.startDrag,
      onTouchStart: this.startDrag
    }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, import_react553.default.createElement("div", {
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/AlphaPicker/AlphaPicker.js
var AlphaPicker = class extends import_react554.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    }), import_react554.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
...
// node_modules/@shopify/polaris/build/esm/components/ColorPicker/components/HuePicker/HuePicker.js
var HuePicker = class extends import_react555.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      sliderHeight: 0,
  ...
  render() {
    ...
    return import_react555.default.createElement("div", {
      ...
      ref: this.setSliderHeight
    }, import_react555.default.createElement(Slidable, {
      draggerY,
      draggerX: 0,
      onChange: this.handleChange,
      onDraggerHeight: this.setDraggerHeight
...
var ColorPicker = class extends import_react556.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      pickerSize: {
  ...
  render() {
    ...
    const alphaSliderMarkup = allowAlpha ? import_react556.default.createElement(AlphaPicker, {
      alpha,
      color,
    ...
    }), import_react556.default.createElement(Slidable, {
      onChange: this.handleDraggerMove,
      draggerX,
      draggerY
    })), import_react556.default.createElement(HuePicker, {
      hue,
      onChange: this.handleHueChange
    }), alphaSliderMarkup, import_react556.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }));
  }
...
var FrameContext = (0, import_react557.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/frame/hooks.js
function useFrame() {
  const frame = (0, import_react558.useContext)(FrameContext);
  if (!frame) {
...
// node_modules/@shopify/polaris/build/esm/components/ContextualSaveBar/ContextualSaveBar.js
var ContextualSaveBar = (0, import_react559.memo)(function ContextualSaveBar2({
  message,
  saveAction,
  discardAction,
  alignContentFlush,
...
function Cell({
  ...
  const iconMarkup = import_react560.default.createElement("span", {
  ...
  const sortableHeadingContent = import_react560.default.createElement("button", {
  ...
  const stickyHeading = import_react560.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? import_react560.default.createElement("th", Object.assign({}, headerCell.props, colSpanProp, {
    ref: setRef,
    className,
    scope: "col",
    "aria-sort": sortDirection,
  ...
  }), columnHeadingContent) : import_react560.default.createElement("th", Object.assign({
    style: {
      minWidth: firstColumnMinWidth
    },
    className,
  ...
  }), import_react560.default.createElement(TruncatedText, {
    className: styles57.TooltipContent
  }, content));
  const cellMarkup = header || firstColumn ? headingMarkup : import_react560.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react560.useRef)(null);
  const {
    current
  } = textRef;
  const text = import_react560.default.createElement("span", {
    ref: textRef,
    className
  }, children2);
  return (current === null || current === void 0 ? void 0 : current.scrollWidth) > (current === null || current === void 0 ? void 0 : current.offsetWidth) ? import_react560.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return import_react561.default.createElement(import_react561.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react562.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react563.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return import_react563.default.createElement("div", null, import_react563.default.createElement("div", {
...
function Sticky(props) {
  ...
  return import_react563.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  return import_react564.default.createElement("div", {
    ...
    ref: setRef
  }, import_react564.default.createElement(Button, {
    plain: true,
    icon: SvgChevronLeftMinor,
    disabled: isScrolledFarthestLeft,
    accessibilityLabel: leftA11yLabel,
    onClick: navigateTableLeft
  }), pipMarkup, import_react564.default.createElement(Button, {
    plain: true,
...
var DataTableInner = class extends import_react565.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = (0, import_react565.createRef)();
    this.scrollContainer = (0, import_react565.createRef)();
    this.table = (0, import_react565.createRef)();
    this.stickyTable = (0, import_react565.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedFirstColumn && inStickyHeader) {
        return [import_react565.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), import_react565.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = (total, index) => {
      ...
      return import_react565.default.createElement(Cell, {
        total: true,
        totalInFooter,
        firstColumn: index === 0,
        key: id,
    ...
    this.defaultRenderRow = ({
      ...
      return import_react565.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = import_react565.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedFirstColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? import_react565.default.createElement("tr", null, totals.map(this.renderTotals)) : null;
    ...
    const fixedFirstColumnMarkup = condensed && fixedFirstColumn && import_react565.default.createElement("table", {
    ...
    }, import_react565.default.createElement("thead", null, import_react565.default.createElement("tr", {
      style: {
      ...
      inFixedFirstColumn: true,
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && import_react565.default.createElement("tr", {
      style: {
        height: `${headerRowHeights[1]}px`
      }
    }, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))), import_react565.default.createElement("tbody", null, firstColumn.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && import_react565.default.createElement("tfoot", null, import_react565.default.createElement("tr", null, firstTotal === null || firstTotal === void 0 ? void 0 : firstTotal.map(this.renderTotals))));
    const bodyMarkup = rows.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedFirstColumn: false
    }));
    const footerMarkup = footerContent ? import_react565.default.createElement("div", {
      className: styles57.Footer
    }, footerContent) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? import_react565.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : import_react565.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? import_react565.default.createElement(AfterInitialMount, null, import_react565.default.createElement("div", {
      className: styles57.StickyHeaderWrapper,
      role: "presentation"
    }, import_react565.default.createElement(Sticky, {
      ...
      }, import_react565.default.createElement("div", null, navigationMarkup("sticky")), import_react565.default.createElement("table", {
    ...
    return import_react565.default.createElement("div", {
      className: wrapperClassName,
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), import_react565.default.createElement("div", {
      className
    }, import_react565.default.createElement("div", {
      className: styles57.ScrollContainer,
      ref: this.scrollContainer
    }, import_react565.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    }), import_react565.default.createElement(EventListener, {
      capture: true,
    ...
    }), fixedFirstColumnMarkup, import_react565.default.createElement("table", {
      className: styles57.Table,
      ref: this.table
    }, import_react565.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), import_react565.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), footerMarkup));
  }
};
function DataTable(props) {
  const i18n = useI18n();
  return import_react565.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
var Weekday = (0, import_react566.memo)(function Weekday2({
  label,
  title,
  current
}) {
  const className = classNames(styles58.Weekday, current && styles58["Weekday-current"]);
  return import_react566.default.createElement("th", {
    "aria-label": label,
    scope: "col",
    className
  }, title);
...
var Day = (0, import_react567.memo)(function Day2({
  day,
  focused,
  onClick,
  onHover = noop7,
  ...
  const i18n = useI18n();
  const dayNode = (0, import_react567.useRef)(null);
  ...
  if (!day) {
    return import_react567.default.createElement("td", {
  ...
  }, import_react567.default.createElement("button", {
    onFocus: () => onFocus(day),
    type: "button",
    ref: dayNode,
    tabIndex,
...
function Month({
  ...
  const weeks = (0, import_react568.useMemo)(() => getWeeksForMonth(month, year, weekStartsOn), [month, weekStartsOn, year]);
  const weekdays = getOrderedWeekdays(weekStartsOn).map((weekday) => import_react568.default.createElement(Weekday, {
    key: weekday,
    title: i18n.translate(`Polaris.DatePicker.daysAbbreviated.${weekdayName(weekday)}`),
    label: weekdayLabel(weekday),
    current: current && new Date().getDay() === weekday
  }));
  const handleDateClick = (0, import_react568.useCallback)((selectedDate) => {
    onChange(getNewRange(allowRange ? selected : void 0, selectedDate));
  }, [allowRange, onChange, selected]);
  const lastDayOfMonth = (0, import_react568.useMemo)(() => new Date(year, month + 1, 0), [month, year]);
  function renderWeek(day, dayIndex) {
    if (day == null) {
      return import_react568.default.createElement(Day, {
        key: dayIndex,
        onHover,
        lastDayOfMonth
      });
  ...
  const weeksMarkup = weeks.map((week, index) => import_react568.default.createElement("tr", {
    className: styles58.Week,
    key: index
  }, week.map(renderWeek)));
  return import_react568.default.createElement("div", {
    className: styles58.MonthContainer
  }, import_react568.default.createElement("table", {
    role: "grid",
    className: styles58.Month
  }, import_react568.default.createElement("caption", {
    className
  }, i18n.translate(`Polaris.DatePicker.months.${monthName(month)}`), " ", year), import_react568.default.createElement("thead", null, import_react568.default.createElement("tr", {
    className: styles58.WeekHeadings
  }, weekdays)), import_react568.default.createElement("tbody", null, weeksMarkup)));
...
function DatePicker({
  ...
  const i18n = useI18n();
  const [hoverDate, setHoverDate] = (0, import_react569.useState)(void 0);
  const [focusDate, setFocusDate] = (0, import_react569.useState)(void 0);
  (0, import_react569.useEffect)(() => {
    setFocusDate(void 0);
  }, [selected]);
  const handleFocus = (0, import_react569.useCallback)((date) => {
    setFocusDate(date);
  }, []);
  const setFocusDateAndHandleMonthChange = (0, import_react569.useCallback)((date) => {
    if (onMonthChange) {
  ...
  const handleDateSelection = (0, import_react569.useCallback)((range) => {
    const {
      end
    } = range;
    setHoverDate(end);
  ...
  const handleMonthChangeClick = (0, import_react569.useCallback)((month2, year2) => {
    if (!onMonthChange) {
      return;
    }
    setFocusDate(void 0);
  ...
  const handleHover = (0, import_react569.useCallback)((date) => {
    setHoverDate(date);
  }, []);
  const handleKeyUp = (0, import_react569.useCallback)((event) => {
    const {
      key
    } = event;
  ...
  const monthIsSelected = (0, import_react569.useMemo)(() => deriveRange(selected), [selected]);
  ...
  const secondDatePicker = multiMonth ? import_react569.default.createElement(Month, {
    onFocus: handleFocus,
  ...
  return import_react569.default.createElement("div", {
    ...
    onKeyUp: handleKeyUp
  }, import_react569.default.createElement("div", {
    className: styles58.Header
  }, import_react569.default.createElement(Button, {
    plain: true,
  ...
  }, import_react569.default.createElement(Month, {
    onFocus: handleFocus,
    focusedDate: focusDate,
    month,
    year,
...
function DescriptionList({
  ...
  const terms = items.reduce((allTerms, {
    term,
    description
  }, index) => [...allTerms, import_react570.default.createElement("dt", {
    key: `dt${index}`,
    className: styles59.Term
  }, term), import_react570.default.createElement("dd", {
    key: `dd${index}`,
    className: styles59.Description
  }, description)], []);
  const className = classNames(styles59.DescriptionList, spacing === "tight" && styles59.spacingTight);
  return import_react570.default.createElement("dl", {
    className
  }, terms);
}
...
function DisplayText({
  ...
  return import_react571.default.createElement(Element2, {
    className
  }, children2);
}
...
// node_modules/@shopify/polaris/build/esm/components/DropZone/context.js
var DropZoneContext = (0, import_react572.createContext)({
  disabled: false,
  focused: false,
  size: "extraLarge",
  type: "file",
...
function FileUpload(props) {
  ...
  const {
    ...
    disabled,
    allowMultiple
  } = (0, import_react573.useContext)(DropZoneContext);
  ...
  const actionMarkup = import_react573.default.createElement("div", {
    className: actionClassNames
  }, actionTitle);
  ...
  const actionHintMarkup = actionHint && import_react573.default.createElement(Caption, null, import_react573.default.createElement(TextStyle, {
    variation: "subdued"
  }, actionHint));
  let viewMarkup;
  switch (size) {
    case "large":
      viewMarkup = import_react573.default.createElement(Stack, {
        vertical: true,
        spacing: "tight"
    ...
    case "medium":
      ...
      break;
    case "small":
      viewMarkup = import_react573.default.createElement("img", {
        width: "20",
        src: uploadArrow,
        alt: ""
      });
...
var DropZone = function DropZone2({
  ...
  const dragTargets = (0, import_react574.useRef)([]);
  const adjustSize = (0, import_react574.useCallback)(debounce(() => {
    if (!node.current) {
      return;
    }
    if (variableHeight) {
  ...
  const [dragging, setDragging] = (0, import_react574.useState)(false);
  const [internalError, setInternalError] = (0, import_react574.useState)(false);
  const {
    value: focused,
    setTrue: handleFocus,
    setFalse: handleBlur
  } = useToggle(false);
  const [size, setSize] = (0, import_react574.useState)("large");
  const [measuring, setMeasuring] = (0, import_react574.useState)(true);
  const i18n = useI18n();
  const getValidatedFiles = (0, import_react574.useCallback)((files) => {
    const acceptedFiles = [];
    const rejectedFiles = [];
  ...
  const handleDrop = (0, import_react574.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
  ...
  const handleDragEnter = (0, import_react574.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    const fileList = getDataTransferFiles(event);
  ...
  const handleDragOver = (0, import_react574.useCallback)((event) => {
    stopEvent(event);
    if (disabled)
      return;
    onDragOver && onDragOver();
  }, [disabled, onDragOver]);
  const handleDragLeave = (0, import_react574.useCallback)((event) => {
    event.preventDefault();
    if (disabled)
      return;
  ...
  const context = (0, import_react574.useMemo)(() => ({
    disabled,
    focused,
    size,
    type: type || "file",
  ...
  return import_react574.default.createElement(DropZoneContext.Provider, {
    value: context
  }, import_react574.default.createElement(Labelled, {
    id,
    label: labelValue,
    action: labelAction,
  ...
  }, dragOverlay, dragErrorOverlay, import_react574.default.createElement(VisuallyHidden, null, import_react574.default.createElement(DropZoneInput, Object.assign({}, inputAttributes, {
    openFileDialog,
    onFileDialogClose
  }))), import_react574.default.createElement("div", {
  ...
  function overlayMarkup(icon, color, text) {
    ...
    }, import_react574.default.createElement(Stack, {
      vertical: true,
      spacing: "tight"
    }, size === "small" && import_react574.default.createElement(Icon, {
      source: icon,
      color
    }), (size === "medium" || size === "large") && import_react574.default.createElement(Caption, null, import_react574.default.createElement(TextStyle, {
      variation: "strong"
    }, text))));
  }
  function open() {
...
var DropZoneInput = class extends import_react574.Component {
  constructor(...args) {
    super(...args);
    this.fileInputNode = (0, import_react574.createRef)();
  ...
  render() {
    ...
    return import_react574.default.createElement("input", Object.assign({}, inputProps, {
...
function EmptySearchResult({
  ...
  const descriptionMarkup = description ? import_react575.default.createElement("p", null, description) : null;
  const illustrationMarkup = withIllustration ? import_react575.default.createElement(Image, {
    alt: altText,
    source: emptySearch,
    draggable: false
  }) : null;
  return import_react575.default.createElement(Stack, {
    alignment: "center",
    vertical: true
  }, illustrationMarkup, import_react575.default.createElement(DisplayText, {
    size: "small"
  }, title), import_react575.default.createElement(TextStyle, {
    variation: "subdued"
  }, descriptionMarkup));
}
...
function EmptyState({
  ...
  const withinContentContainer = (0, import_react576.useContext)(WithinContentContext);
  ...
  const imageMarkup = largeImage ? import_react576.default.createElement(Image, {
    alt: "",
    role: "presentation",
  ...
  }) : import_react576.default.createElement(Image, {
    role: "presentation",
    alt: "",
    className: styles63.Image,
    source: image
  ...
  const footerContentMarkup = footerContent ? import_react576.default.createElement("div", {
    className: styles63.FooterContent
  }, import_react576.default.createElement(TextContainer, null, footerContent)) : null;
  const headingSize = withinContentContainer ? "small" : "medium";
  const primaryActionMarkup = action ? buttonFrom(action, {
    primary: true,
    size: "medium"
  }) : null;
  const headingMarkup = heading ? import_react576.default.createElement(DisplayText, {
    size: headingSize
  }, heading) : null;
  const childrenMarkup = children2 ? import_react576.default.createElement("div", {
    className: styles63.Content
  }, children2) : null;
  const textContentMarkup = headingMarkup || children2 ? import_react576.default.createElement(TextContainer, null, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react576.default.createElement("div", {
    className: styles63.Actions
  }, import_react576.default.createElement(Stack, {
    alignment: "center",
    distribution: "center",
    spacing: "tight"
  }, secondaryActionMarkup, primaryActionMarkup)) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? import_react576.default.createElement("div", {
    className: styles63.DetailsContainer
  }, import_react576.default.createElement("div", {
    className: styles63.Details
  }, textContentMarkup, actionsMarkup, footerContentMarkup)) : import_react576.default.createElement("div", {
    className: styles63.DetailsContainer
  });
  ...
  }, detailsMarkup, import_react576.default.createElement("div", {
...
function Truncate({
  ...
  return import_react577.default.createElement("span", {
...
function ExceptionList({
  ...
  const items = itemsList.map((item, index) => {
    ...
    const iconMarkup = icon ? import_react578.default.createElement(Icon, {
      source: icon
    }) : import_react578.default.createElement("span", {
      className: styles64.Bullet
    });
    const titleMarkup = title && import_react578.default.createElement("span", {
      className: styles64.Title
    }, title);
    const descriptionMarkup = description && import_react578.default.createElement("span", {
      className: styles64.Description
    }, description);
    const Element2 = truncate ? Truncate : import_react578.Fragment;
    return import_react578.default.createElement("li", {
      className: itemClasses,
      key: index
    }, import_react578.default.createElement("span", {
      className: styles64.Icon
    }, iconMarkup), import_react578.default.createElement(Element2, null, titleMarkup, descriptionMarkup));
  });
  return import_react578.default.createElement("ul", {
...
var ConnectedFilterControl = class extends import_react580.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      availableWidth: 0,
    ...
    this.container = (0, import_react580.createRef)();
    this.proxyButtonContainer = (0, import_react580.createRef)();
    this.moreFiltersButtonContainer = (0, import_react580.createRef)();
    this.handleResize = debounce(() => {
  ...
  render() {
    ...
    const rightMarkup = actionsToRender.length > 0 ? import_react580.default.createElement("div", {
    ...
    const rightActionMarkup = rightAction ? import_react580.default.createElement("div", {
      ref: this.moreFiltersButtonContainer,
      className: moreFiltersButtonContainerClassname
    }, shouldRenderMoreFiltersButton && import_react580.default.createElement(Item5, null, rightAction)) : null;
    const proxyButtonMarkup = rightPopoverableActions ? import_react580.default.createElement("div", {
      className: styles67.ProxyButtonContainer,
      ref: this.proxyButtonContainer,
      "aria-hidden": true
    }, rightPopoverableActions.map((action) => import_react580.default.createElement("div", {
      key: action.key,
      "data-key": action.key
    }, this.activatorButtonFrom(action, {
      proxy: true
    })))) : null;
    const auxMarkup = auxiliary ? import_react580.default.createElement("div", {
      className: styles67.AuxiliaryContainer
    }, auxiliary) : null;
    return import_react580.default.createElement(import_react580.default.Fragment, null, proxyButtonMarkup, import_react580.default.createElement("div", {
      className: styles67.Wrapper
    }, import_react580.default.createElement("div", {
      className,
      ref: this.container
    }, children2 ? import_react580.default.createElement("div", {
      className: styles67.CenterContainer
    }, import_react580.default.createElement(Item5, null, children2)) : null, rightMarkup, rightActionMarkup, import_react580.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })), auxMarkup));
  }
  ...
  activatorButtonFrom(action, options) {
    ...
    return import_react580.default.createElement(Button, {
      onClick: action.onAction,
      disclosure: true,
  ...
  popoverFrom(actions) {
    return actions.map((action) => {
      return import_react580.default.createElement(Item5, {
        key: action.key
      }, import_react580.default.createElement(Popover2, {
...
function TagsWrapper({
  ...
  if (hidden) {
    return import_react581.default.createElement(VisuallyHidden, null, children2);
  }
  return import_react581.default.createElement(import_react581.default.Fragment, null, children2);
}
...
function Tag({
  ...
  if (onClick) {
    return import_react582.default.createElement("button", {
      type: "button",
      disabled,
      className,
      onClick
  ...
  const removeButton = onRemove ? import_react582.default.createElement("button", {
    type: "button",
    "aria-label": ariaLabel,
    ...
    onMouseUp: handleMouseUpByBlurring,
    disabled
  }, import_react582.default.createElement(Icon, {
    source: SvgCancelSmallMinor
  })) : null;
  const tagContent = url && !disabled ? import_react582.default.createElement("a", {
    className: classNames(styles68.Link, segmented && styles68.segmented),
    href: url
  }, import_react582.default.createElement("span", {
    title: tagTitle,
    className: styles68.LinkText
  }, children2)) : import_react582.default.createElement("span", {
    title: tagTitle,
    className: styles68.TagText
  }, children2);
  return import_react582.default.createElement("span", {
    className
...
function useMediaQuery() {
  const mediaQuery = (0, import_react583.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function useFocusManager({
  ...
  const focusManager = (0, import_react584.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react584.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var Focus = (0, import_react585.memo)(function Focus2({
  children: children2,
  disabled,
  root
}) {
  (0, import_react585.useEffect)(() => {
    if (disabled || !root) {
      return;
    }
  ...
  return import_react585.default.createElement(import_react585.default.Fragment, null, children2);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react586.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react586.useState)(true);
  ...
  return import_react586.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, import_react586.default.createElement("div", {
    ref: focusTrapWrapper
  }, import_react586.default.createElement(EventListener, {
    event: "focusin",
...
function Sheet({
  ...
  const container = (0, import_react587.useRef)(null);
  const activatorRef = (0, import_react587.useRef)(null);
  const handleClose = (0, import_react587.useCallback)(() => {
    onClose();
  ...
  const activatorMarkup = activator && !isRef2(activator) ? import_react587.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react587.default.createElement(import_react587.default.Fragment, null, activatorMarkup, import_react587.default.createElement(Portal, {
    idPrefix: "sheet"
  }, import_react587.default.createElement(CSSTransition_default, {
    nodeRef: container,
    ...
    onEntered,
    onExit
  }, import_react587.default.createElement("div", Object.assign({
    className: styles69.Container
  }, layer.props, overlay.props, {
    ref: container
  }), import_react587.default.createElement(TrapFocus, {
    trapping: open
    ...
    "aria-label": accessibilityLabel
  }, children2)))), import_react587.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: handleClose
  }), open && import_react587.default.createElement(Backdrop, {
    transparent: true,
    onClick: handleClose
  })));
}
...
var FiltersInner = class extends import_react588.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      open: false,
    ...
    this.moreFiltersButtonContainer = (0, import_react588.createRef)();
    this.moreFiltersDoneButtonContainer = (0, import_react588.createRef)();
    this.focusNode = (0, import_react588.createRef)();
    this.closeFilters = () => {
      this.setState({
        open: false
      }, () => {
  ...
  render() {
    ...
    const backdropMarkup = open ? import_react588.default.createElement(import_react588.default.Fragment, null, import_react588.default.createElement(ScrollLock, null), import_react588.default.createElement("div", {
    ...
    const filtersContentMarkup = filters.map((filter, index) => {
      ...
      const appliedFilterBadgeMarkup = appliedFilterContent ? import_react588.default.createElement("div", {
        className: styles66.AppliedFilterBadgeContainer
      }, import_react588.default.createElement(Badge, {
        size: "small",
        status: "new"
      ...
      return import_react588.default.createElement("div", {
        key: filter.key,
        className
      }, import_react588.default.createElement("button", {
      ...
      }, import_react588.default.createElement("h3", {
        className: styles66.FilterTriggerTitle
      }, import_react588.default.createElement(TextStyle, {
        variation: this.props.disabled || filter.disabled ? "subdued" : void 0
      }, filter.label)), import_react588.default.createElement("span", {
        className: styles66.FilterTriggerIcon
      }, import_react588.default.createElement(Icon, {
        source: icon,
        color: "base"
      }))), appliedFilterBadgeMarkup), import_react588.default.createElement(Collapsible, {
        id: collapsibleID,
        open: filterIsOpen
      }, import_react588.default.createElement("div", {
        className: styles66.FilterNodeContainer
      }, import_react588.default.createElement(Focus, {
    ...
    const rightActionMarkup = filters.length ? import_react588.default.createElement("div", {
      ref: this.moreFiltersButtonContainer
    }, import_react588.default.createElement(Button, {
    ...
    const filtersControlMarkup = import_react588.default.createElement(ConnectedFilterControl, {
    ...
    }, hideQueryField ? null : import_react588.default.createElement(TextField, {
      ...
      labelHidden: true,
      prefix: import_react588.default.createElement("span", {
    ...
    const filtersDesktopHeaderMarkup = import_react588.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react588.default.createElement(DisplayText, {
      size: "small",
      element: "h3"
    }, moreFiltersLabel), import_react588.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
      accessibilityLabel: i18n.translate("Polaris.Filters.cancel"),
      onClick: this.closeFilters
    }));
    const filtersMobileHeaderMarkup = import_react588.default.createElement("div", {
      className: filtersContainerHeaderClassname
    }, import_react588.default.createElement(Button, {
      icon: SvgCancelSmallMinor,
      plain: true,
    ...
    const filtersDesktopFooterMarkup = import_react588.default.createElement("div", {
      className: filtersDesktopFooterClassname
    }, import_react588.default.createElement(Button, {
      onClick: this.handleClearAll,
      disabled: !this.hasAppliedFilters()
    }, i18n.translate("Polaris.Filters.clearAllFilters")), import_react588.default.createElement("div", {
      ref: this.moreFiltersDoneButtonContainer
    }, import_react588.default.createElement(Button, {
      onClick: this.closeFilters,
      primary: true
    }, i18n.translate("Polaris.Filters.done"))));
    const filtersMobileFooterMarkup = import_react588.default.createElement("div", {
      className: styles66.FiltersMobileContainerFooter
    }, this.hasAppliedFilters() ? import_react588.default.createElement(Button, {
      onClick: onClearAll,
      fullWidth: true
    }, i18n.translate("Polaris.Filters.clearAllFilters")) : import_react588.default.createElement("div", {
      ...
      variation: "subdued"
    }, import_react588.default.createElement("p", null, i18n.translate("Polaris.Filters.noFiltersApplied")))));
    const shouldHideTagsContainer = !appliedFilters || appliedFilters.length < 1;
    const tagsMarkup = !hideTags ? import_react588.default.createElement(TagsWrapper, {
      hidden: shouldHideTagsContainer
    }, import_react588.default.createElement("div", {
      className: styles66.TagsContainer,
      "aria-live": "polite"
    }, (appliedFilters || []).map((filter) => {
      return import_react588.default.createElement(Tag, {
        key: filter.key,
        onRemove: () => {
    ...
    const filtersContainerMarkup = isNavigationCollapsed ? import_react588.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
      onExit: this.setReadyForFocus(false)
    }, filtersMobileHeaderMarkup, import_react588.default.createElement(Scrollable, {
      className: filtersMobileContainerContentClassName,
      shadow: true
    }, filtersContentMarkup, filtersMobileFooterMarkup)) : import_react588.default.createElement(Sheet, {
      accessibilityLabel: moreFiltersLabel,
      open,
      onClose: this.closeFilters,
      onEntered: this.setReadyForFocus(true),
    ...
    }, filtersDesktopHeaderMarkup, import_react588.default.createElement(Scrollable, {
      className: filtersDesktopContainerContentClassName,
      shadow: true
    }, filtersContentMarkup), filtersDesktopFooterMarkup));
    const helpTextMarkup = helpText ? import_react588.default.createElement("div", {
      id: "FiltersHelpText",
      className: styles66.HelpText
    }, import_react588.default.createElement(TextStyle, {
      variation: "subdued"
    }, helpText)) : null;
    return import_react588.default.createElement(WithinFilterContext.Provider, {
      value: true
    }, import_react588.default.createElement("div", {
      className: styles66.Filters
    }, filtersControlMarkup, filtersContainerMarkup, tagsMarkup, helpTextMarkup, backdropMarkup, import_react588.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
  ...
  generateFilterMarkup(filter) {
    ...
    const clearButtonMarkup = !filter.hideClearButton && import_react588.default.createElement(Button, {
      plain: true,
...
function Filters(props) {
  ...
  return import_react588.default.createElement(FiltersInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FooterHelp({
  ...
  return import_react589.default.createElement("div", {
...
function Form({
  ...
  const i18n = useI18n();
  const handleSubmit = (0, import_react590.useCallback)((event) => {
    if (!preventDefault2) {
      return;
    }
    event.preventDefault();
  ...
  const submitMarkup = implicitSubmit ? import_react590.default.createElement(VisuallyHidden, null, import_react590.default.createElement("button", {
    type: "submit",
    "aria-hidden": "true",
    tabIndex: -1
  }, i18n.translate("Polaris.Common.submit"))) : null;
  return import_react590.default.createElement("form", {
    acceptCharset,
    action,
...
function Item6({
  ...
  return children2 ? import_react591.default.createElement("div", {
...
function Group({
  ...
  if (helpText) {
    ...
    helpTextElement = import_react592.default.createElement("div", {
      id: helpTextID3,
  ...
  if (title) {
    titleID = `${id}Title`;
    titleElement = import_react592.default.createElement("div", {
      id: titleID,
      className: styles71.Title
    }, title);
  }
  const itemsMarkup = import_react592.Children.map(children2, (child) => wrapWithComponent(child, Item6, {}));
  return import_react592.default.createElement("div", {
    role: "group",
    className,
...
// node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = (0, import_react593.memo)(function FormLayout2({
  children: children2
}) {
  return import_react593.default.createElement("div", {
    className: styles71.FormLayout
  }, import_react593.Children.map(children2, wrapChildren));
});
...
function useIsMountedRef() {
  const isMounted = (0, import_react594.useRef)(false);
...
function Loading2() {
  ...
  const [progress, setProgress] = (0, import_react595.useState)(0);
  const [animating, setAnimating] = (0, import_react595.useState)(false);
  ...
  return import_react595.default.createElement("div", {
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react596.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react596.useRef)(false);
  const node = (0, import_react596.useRef)(null);
  (0, import_react596.useEffect)(() => {
  ...
  return import_react596.default.createElement("div", {
    className: wrapperClassName,
    ref: node,
...
function Dialog({
  ...
  const containerNode = (0, import_react597.useRef)(null);
  ...
  return import_react597.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, import_react597.default.createElement(TrapFocus, null, import_react597.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
    ...
    className: classes
  }, import_react597.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onClose
  }), children2)))));
}
...
function FadeUp({
  ...
  return import_react597.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return import_react598.default.createElement("button", {
    onClick,
...
function Header3({
  ...
  }, import_react599.default.createElement(DisplayText, {
    element: "h2",
    size: "small"
  }, children2)), import_react599.default.createElement(CloseButton, {
    titleHidden,
    onClick: onClose
  }));
}
...
function Section5({
  ...
  return import_react600.default.createElement("section", {
    className
  }, children2);
}
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? import_react601.default.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  ...
  }, import_react601.default.createElement(Stack, {
    alignment: "center"
  }, import_react601.default.createElement(Stack.Item, {
    fill: true
  }, children2), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react602.useState)(IFRAME_LOADING_HEIGHT);
  const headerId = useUniqueId("modal-header");
  const activatorRef = (0, import_react602.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react602.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react602.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react602.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : import_react602.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? import_react602.default.createElement("div", {
      className: styles76.Spinner
    }, import_react602.default.createElement(Spinner, null)) : content;
    const scrollContainerMarkup = noScroll ? import_react602.default.createElement("div", {
      className: styles76.Body
    }, body) : import_react602.default.createElement(Scrollable, {
      shadow: true,
      className: styles76.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? import_react602.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = import_react602.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      fullScreen
    }, import_react602.default.createElement(Header3, {
      titleHidden,
      id: headerId,
      onClose
    }, title), import_react602.default.createElement("div", {
      className: styles76.BodyWrapper
    }, bodyMarkup), footerMarkup);
    backdrop = import_react602.default.createElement(Backdrop, {
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef3(activator) ? import_react602.default.createElement("div", {
    ref: activatorRef
  }, activator) : null;
  return import_react602.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, import_react602.default.createElement(Portal, {
    idPrefix: "modal"
  }, import_react602.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function ContextualSaveBar3({
  ...
  const handleDiscardAction = (0, import_react604.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && import_react604.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && import_react604.default.createElement(Button, {
  ...
  const saveActionMarkup = saveAction && import_react604.default.createElement(Button, {
    primary: true,
    url: saveAction.url,
  ...
  const imageMarkup = logo && import_react604.default.createElement(Image, {
    style: {
      width
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : import_react604.default.createElement("div", {
    className: styles75.LogoContainer,
    style: {
      width
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? import_react604.default.createElement("div", {
    className: styles75.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles75.Contents, fullWidth && styles75.fullWidth);
  return import_react604.default.createElement(import_react604.default.Fragment, null, import_react604.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react604.default.createElement("div", {
    className: styles75.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, import_react604.default.createElement("div", {
    className: contentsClassName
  }, import_react604.default.createElement("h2", {
    className: styles75.Message
  }, message), import_react604.default.createElement("div", {
    className: styles75.ActionContainer
  }, import_react604.default.createElement(Stack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare2.default) {
  const dependencyList = (0, import_react605.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react606.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react607.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const dismissMarkup = import_react608.default.createElement("button", {
    type: "button",
    className: styles83.CloseButton,
    onClick: onDismiss
  }, import_react608.default.createElement(Icon, {
    source: SvgMobileCancelMajor
  }));
  const actionMarkup = action ? import_react608.default.createElement("div", {
    className: styles83.Action
  }, import_react608.default.createElement(Button, {
    plain: true,
    monochrome: true,
    onClick: action.onAction
  }, action.content)) : null;
  const className = classNames(styles83.Toast, error && styles83.error);
  return import_react608.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react608.default.createElement("div", {
    className
  }, import_react608.default.createElement(KeypressListener, {
    keyCode: Key.Escape,
    handler: onDismiss
...
// node_modules/@shopify/polaris/build/esm/components/Frame/components/ToastManager/ToastManager.js
var ToastManager = (0, import_react609.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    const toastNode = (0, import_react609.createRef)();
    toastNodes[index] = toastNode;
    return import_react609.default.createElement(CSSTransition_default, {
      ...
      ref: toastNode
    }, import_react609.default.createElement(Toast, toast)));
  });
  return import_react609.default.createElement(Portal, null, import_react609.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), import_react609.default.createElement("div", {
    className: styles82.ToastManager,
    "aria-live": "assertive"
  }, import_react609.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
...
var FrameInner = class extends import_react610.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = (0, import_react610.createRef)();
  ...
  render() {
    ...
    const navigationMarkup = navigation ? import_react610.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, import_react610.default.createElement(CSSTransition_default, {
    ...
    }, import_react610.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, import_react610.default.createElement("button", {
      type: "button",
      ...
      tabIndex
    }, import_react610.default.createElement(Icon, {
      source: SvgMobileCancelMajor
    }))))) : null;
    const loadingMarkup = loadingStack > 0 ? import_react610.default.createElement("div", {
      className: styles72.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, import_react610.default.createElement(Loading2, null)) : null;
    const contextualSaveBarMarkup = import_react610.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles72.ContextualSaveBar,
      type: "fade"
    }, import_react610.default.createElement(ContextualSaveBar3, this.contextualSaveBar));
    const topBarMarkup = topBar ? import_react610.default.createElement("div", Object.assign({
      className: styles72.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? import_react610.default.createElement("div", {
    ...
    const skipMarkup = import_react610.default.createElement("div", {
      className: skipClassName
    }, import_react610.default.createElement("a", {
      href: `#${skipTarget}`,
    ...
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? import_react610.default.createElement(Backdrop, {
    ...
    return import_react610.default.createElement(FrameContext.Provider, {
      value: context
    }, import_react610.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, import_react610.default.createElement("main", {
      className: styles72.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, import_react610.default.createElement("div", {
      className: styles72.Content
    }, children2)), import_react610.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, import_react610.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return import_react610.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function FullscreenBar({
  ...
  const i18n = useI18n();
  return import_react611.default.createElement("div", {
    className: styles84.FullscreenBar
  }, import_react611.default.createElement("button", {
    className: styles84.BackAction,
    onClick: onAction,
    "aria-label": i18n.translate("Polaris.FullscreenBar.accessibilityLabel")
  }, import_react611.default.createElement(Icon, {
    source: SvgExitMajor
...
var IndexContext = (0, import_react614.createContext)(void 0);
var IndexSelectionChangeContext = (0, import_react614.createContext)(void 0);
var IndexRowContext = (0, import_react614.createContext)(void 0);

// node_modules/@shopify/polaris/build/esm/utilities/index-provider/hooks.js
function useIndexSelectionChange() {
  const onSelectionChange = (0, import_react615.useContext)(IndexSelectionChangeContext);
...
function useIndexRow() {
  const indexRow = (0, import_react615.useContext)(IndexRowContext);
  if (!indexRow) {
    throw new Error(`Missing IndexProvider context`);
  }
  return indexRow;
...
function useIndexValue() {
  const index = (0, import_react615.useContext)(IndexContext);
  if (!index) {
    throw new Error(`Missing IndexProvider context`);
  }
  return index;
...
function useHandleBulkSelection({
  ...
  const lastSelected = (0, import_react615.useRef)(null);
  const handleSelectionChange = (0, import_react615.useCallback)((selectionType, toggleType, selection, sortOrder) => {
...
function IndexProvider({
  ...
  const contextValue = (0, import_react616.useMemo)(() => ({
    itemCount,
  ...
  const rowContextValue = (0, import_react616.useMemo)(() => ({
    selectable: isSelectableIndex,
    selectMode: selectMode && isSelectableIndex,
    condensed
  }), [condensed, selectMode, isSelectableIndex]);
  return import_react616.default.createElement(IndexContext.Provider, {
    value: contextValue
  }, import_react616.default.createElement(IndexRowContext.Provider, {
    value: rowContextValue
  }, import_react616.default.createElement(IndexSelectionChangeContext.Provider, {
...
var Cell3 = (0, import_react617.memo)(function Cell4({
  children: children2,
  className,
  flush
}) {
  const cellClassName = classNames(className, styles87.TableCell, flush && styles87["TableCell-flush"]);
  return import_react617.default.createElement("td", {
...
var RowContext = (0, import_react618.createContext)({});
var RowHoveredContext = (0, import_react618.createContext)(void 0);
var scrollDefaultContext = {
  scrollableContainer: null,
  canScrollLeft: false,
  canScrollRight: false
};
var ScrollContext = (0, import_react618.createContext)(scrollDefaultContext);

// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Checkbox/Checkbox.js
var Checkbox3 = (0, import_react619.memo)(function Checkbox4() {
  const i18n = useI18n();
  const {
    resourceName,
    condensed
  ...
  const {
    ...
    disabled,
    onInteraction
  } = (0, import_react619.useContext)(RowContext);
  const wrapperClassName = classNames(styles88.Wrapper, condensed ? styles88.condensed : styles88.expanded);
  const Wrapper = condensed ? import_react619.Fragment : CheckboxWrapper;
  return import_react619.default.createElement(Wrapper, null, import_react619.default.createElement("div", {
    className: styles88.TableCellContentContainer
  }, import_react619.default.createElement("div", {
    className: wrapperClassName,
    onClick: onInteraction,
    onKeyUp: noop10
  }, import_react619.default.createElement(Checkbox, {
    id: itemId,
...
function CheckboxWrapper({
  ...
  const checkboxNode = (0, import_react619.useRef)(null);
  const handleResize = (0, import_react619.useCallback)(() => {
  ...
  return import_react619.default.createElement("td", {
...
// node_modules/@shopify/polaris/build/esm/components/IndexTable/components/Row/Row.js
var Row = (0, import_react620.memo)(function Row2({
  children: children2,
  selected,
  id,
  position,
  ...
  const handleInteraction = (0, import_react620.useCallback)((event) => {
    event.stopPropagation();
  ...
  const contextValue = (0, import_react620.useMemo)(() => ({
    itemId: id,
    selected,
    onInteraction: handleInteraction,
    disabled
  }), [id, selected, disabled, handleInteraction]);
  const primaryLinkElement = (0, import_react620.useRef)(null);
  const isNavigating = (0, import_react620.useRef)(false);
  const tableRowRef = (0, import_react620.useRef)(null);
  const tableRowCallbackRef = (0, import_react620.useCallback)((node) => {
  ...
  const checkboxMarkup = selectable ? import_react620.default.createElement(Checkbox3, null) : null;
  return import_react620.default.createElement(RowContext.Provider, {
    value: contextValue
  }, import_react620.default.createElement(RowHoveredContext.Provider, {
    value: hovered
  }, import_react620.default.createElement(RowWrapper, {
    key: id,
...
function ScrollContainer({
  ...
  (0, import_react621.useEffect)(() => {
    if (!scrollableContainerRef.current)
      return;
    scrollableContainerRef.current.dispatchEvent(new Event("scroll"));
  }, [scrollableContainerRef]);
  const [containerScroll, setContainerScroll] = (0, import_react621.useState)(scrollDefaultContext);
  const handleScroll = (0, import_react621.useCallback)(debounce(() => {
    if (!scrollableContainerRef.current) {
      return;
    }
  ...
  return import_react621.default.createElement(ScrollContext.Provider, {
    value: containerScroll
  }, import_react621.default.createElement("div", {
...
function IndexTableBase({
  ...
  const tablePosition = (0, import_react622.useRef)({
    top: 0,
    left: 0
  });
  const tableHeadingRects = (0, import_react622.useRef)([]);
  const scrollableContainerElement = (0, import_react622.useRef)(null);
  const tableElement = (0, import_react622.useRef)(null);
  const condensedListElement = (0, import_react622.useRef)(null);
  const [tableInitialized, setTableInitialized] = (0, import_react622.useState)(false);
  const [isSmallScreenSelectable, setIsSmallScreenSelectable] = (0, import_react622.useState)(false);
  const [stickyWrapper, setStickyWrapper] = (0, import_react622.useState)(null);
  const [hideScrollContainer, setHideScrollContainer] = (0, import_react622.useState)(false);
  const [smallScreen, setSmallScreen] = (0, import_react622.useState)(isSmallScreen());
  const tableHeadings = (0, import_react622.useRef)([]);
  const stickyTableHeadings = (0, import_react622.useRef)([]);
  const stickyHeaderWrapperElement = (0, import_react622.useRef)(null);
  const firstStickyHeaderElement = (0, import_react622.useRef)(null);
  const stickyHeaderElement = (0, import_react622.useRef)(null);
  const scrollBarElement = (0, import_react622.useRef)(null);
  const scrollContainerElement = (0, import_react622.useRef)(null);
  const scrollingWithBar = (0, import_react622.useRef)(false);
  const scrollingContainer = (0, import_react622.useRef)(false);
  const tableBodyRef = (0, import_react622.useCallback)((node) => {
    if (node !== null && !tableInitialized) {
      setTableInitialized(true);
    }
  }, [tableInitialized]);
  const toggleIsSmallScreenSelectable = (0, import_react622.useCallback)(() => {
    setIsSmallScreenSelectable((value) => !value);
  }, []);
  const handleSelectAllItemsInStore = (0, import_react622.useCallback)(() => {
  ...
  const calculateFirstHeaderOffset = (0, import_react622.useCallback)(() => {
    if (!selectable) {
  ...
  const resizeTableHeadings = (0, import_react622.useMemo)(() => debounce(() => {
  ...
  const resizeTableScrollBar = (0, import_react622.useCallback)(() => {
  ...
  const debounceResizeTableScrollbar = (0, import_react622.useCallback)(debounce(resizeTableScrollBar, SCROLL_BAR_DEBOUNCE_PERIOD, {
    trailing: true
  }), [resizeTableScrollBar]);
  const [canScrollRight, setCanScrollRight] = (0, import_react622.useState)(true);
  const handleCanScrollRight = (0, import_react622.useCallback)(() => {
  ...
  const handleIsSmallScreen = (0, import_react622.useCallback)(() => {
    setSmallScreen(smallScreen);
  }, [smallScreen]);
  const handleResize = (0, import_react622.useCallback)(() => {
  ...
  const handleScrollContainerScroll = (0, import_react622.useCallback)((canScrollLeft, canScrollRight2) => {
  ...
  const handleScrollBarScroll = (0, import_react622.useCallback)(() => {
    if (!scrollableContainerElement.current || !scrollBarElement.current) {
      return;
    }
  ...
  const stickyColumnHeader = import_react622.default.createElement("div", {
    className: styles87.TableHeading,
    key: headings[0].title,
    style: stickyColumnHeaderStyle,
    "data-index-table-sticky-heading": true
  }, import_react622.default.createElement(Stack, {
    spacing: "none",
    wrap: false,
    alignment: "center"
  }, selectable && import_react622.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderCheckboxContent()), selectable && import_react622.default.createElement("div", {
    className: styles87["StickyTableHeading-second-scrolling"]
  }, renderHeadingContent(headings[0], 0)), !selectable && import_react622.default.createElement("div", {
    className: styles87.FirstStickyHeaderElement,
    ref: firstStickyHeaderElement
  }, renderHeadingContent(headings[0], 0))));
  const stickyHeadingsMarkup = headings.map(renderStickyHeading);
  const selectedItemsCountLabel = selectedItemsCount === SELECT_ALL_ITEMS ? `${itemCount}+` : selectedItemsCount;
  const handleTogglePage = (0, import_react622.useCallback)(() => {
  ...
  const loadingMarkup = import_react622.default.createElement(CSSTransition_default, {
    in: loading,
  ...
  }, import_react622.default.createElement(Spinner, {
    size: "small"
  }), import_react622.default.createElement("span", {
  ...
  const stickyHeaderMarkup = import_react622.default.createElement("div", {
    className: stickyTableClassNames,
    role: "presentation"
  }, import_react622.default.createElement(Sticky, {
    ...
    const bulkActionsMarkup = shouldShowBulkActions ? import_react622.default.createElement("div", {
      className: bulkActionClassNames,
      "data-condensed": condensed
    }, loadingMarkup, import_react622.default.createElement(BulkActions, {
      smallScreen,
    ...
    const selectButtonMarkup = import_react622.default.createElement(Button, {
      icon: SvgEnableSelectionMinor,
      onClick: toggleIsSmallScreenSelectable
    }, i18n.translate("Polaris.IndexTable.selectButtonText"));
    const headerMarkup = condensed ? import_react622.default.createElement("div", {
      className: classNames(styles87.HeaderWrapper, !selectable && styles87.unselectable)
    }, loadingMarkup, sort, selectable && selectButtonMarkup) : import_react622.default.createElement("div", {
      className: stickyHeaderClassNames,
      ref: stickyHeaderWrapperElement
    }, loadingMarkup, import_react622.default.createElement("div", {
      className: stickyColumnHeaderClassNames
    }, stickyColumnHeader), import_react622.default.createElement("div", {
  ...
  const scrollBarMarkup = itemCount > 0 ? import_react622.default.createElement(AfterInitialMount, null, import_react622.default.createElement("div", {
  ...
  const emptyStateMarkup = emptyState ? emptyState : import_react622.default.createElement(EmptySearchResult, {
  ...
  const sharedMarkup = import_react622.default.createElement(import_react622.default.Fragment, null, import_react622.default.createElement(EventListener, {
    event: "resize",
    handler: handleResize
  }), import_react622.default.createElement(AfterInitialMount, null, stickyHeaderMarkup));
  const bodyMarkup = condensed ? import_react622.default.createElement(import_react622.default.Fragment, null, sharedMarkup, import_react622.default.createElement("ul", {
    "data-selectmode": Boolean(selectMode || isSmallScreenSelectable),
    className: styles87.CondensedList,
    ref: condensedListElement
  }, children2)) : import_react622.default.createElement(import_react622.default.Fragment, null, sharedMarkup, import_react622.default.createElement(ScrollContainer, {
    scrollableContainerRef: scrollableContainerElement,
    onScroll: handleScrollContainerScroll
  }, import_react622.default.createElement("table", {
    ref: tableElement,
    className: tableClassNames
  }, import_react622.default.createElement("thead", null, import_react622.default.createElement("tr", {
    className: styles87.HeadingRow
  }, headingsMarkup)), import_react622.default.createElement("tbody", {
    ref: tableBodyRef
  }, children2))));
  const tableContentMarkup = itemCount > 0 ? bodyMarkup : import_react622.default.createElement("div", {
    className: styles87.EmptySearchResultWrapper
  }, emptyStateMarkup);
  return import_react622.default.createElement(import_react622.default.Fragment, null, import_react622.default.createElement("div", {
  ...
  function renderHeading(heading, index) {
    ...
    const headingContent = import_react622.default.createElement("th", {
    ...
    const checkboxContent = import_react622.default.createElement("th", {
      className: checkboxClassName,
      key: `${heading}-${index}`,
      "data-index-table-heading": true
  ...
  function renderCheckboxContent() {
    ...
    }, import_react622.default.createElement(Checkbox, {
  ...
  function renderHeadingContent(heading, index) {
    let headingContent;
    if (heading.new) {
      headingContent = import_react622.default.createElement(Stack, {
        wrap: false,
        alignment: "center"
      }, import_react622.default.createElement("span", null, heading.title), import_react622.default.createElement(Badge, {
        status: "new"
      }, i18n.translate("Polaris.IndexTable.onboardingBadgeText")));
    } else if (heading.hidden) {
      headingContent = import_react622.default.createElement(VisuallyHidden, null, heading.title);
    } else {
    ...
    if (sortable !== null && sortable !== void 0 && sortable[index]) {
      ...
      const iconMarkup = import_react622.default.createElement("span", {
      ...
      return import_react622.default.createElement(UnstyledButton, {
...
function IndexTable({
  ...
  return import_react622.default.createElement(IndexProvider, {
    selectable,
    itemCount,
    selectedItemsCount,
    resourceName: passedResourceName,
    ...
    condensed,
    onSelectionChange
  }, import_react622.default.createElement(IndexTableBase, indexTableBaseProps, children2));
}
...
function KeyboardKey({
  ...
  return import_react623.default.createElement("kbd", {
...
function KonamiCode({
  ...
  const [position, setPosition] = (0, import_react624.useState)(0);
...
function AnnotatedSection(props) {
  ...
  const descriptionMarkup = typeof description === "string" ? import_react625.default.createElement("p", null, description) : description;
  ...
  }, import_react625.default.createElement(TextContainer, null, import_react625.default.createElement(Heading, {
    id
  }, title), descriptionMarkup && import_react625.default.createElement("div", {
    className: styles91.AnnotationDescription
  }, descriptionMarkup))), import_react625.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? import_react627.default.createElement(Section6, null, children2) : children2;
...
function Link({
  ...
  return import_react628.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? import_react628.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      ...
      "aria-label": accessibilityLabel,
      "data-primary-link": dataPrimaryLink
    }, children2) : import_react628.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
function Item7({
  ...
  return import_react629.default.createElement("li", {
...
var List = function List2({
  ...
  return import_react630.default.createElement(ListElement, {
    className
  }, children2);
};
List.Item = Item7;
...
var Loading3 = (0, import_react631.memo)(function Loading4() {
  const {
    startLoading,
    stopLoading
  } = useFrame();
  (0, import_react631.useEffect)(() => {
    startLoading();
    return () => {
      stopLoading();
    };
...
function MediaCard({
  ...
  if (title) {
    const headerContent = typeof title === "string" ? import_react632.default.createElement(Heading, null, title) : title;
    headerMarkup = import_react632.default.createElement("div", {
      className: styles94.Heading
    }, headerContent);
  }
  const popoverActivator = import_react632.default.createElement(Button, {
    icon: SvgHorizontalDotsMinor,
  ...
  const popoverActionsMarkup = popoverActions.length > 0 ? import_react632.default.createElement("div", {
    className: styles94.Popover
  }, import_react632.default.createElement(Popover2, {
    active: popoverActive,
    activator: popoverActivator,
    onClose: togglePopoverActive,
    preferredAlignment: "left",
    preferredPosition: "below"
  }, import_react632.default.createElement(ActionList, {
    items: popoverActions,
    onActionAnyItem: togglePopoverActive
  }))) : null;
  const primaryActionMarkup = primaryAction ? import_react632.default.createElement("div", {
    className: styles94.PrimaryAction
  }, buttonFrom(primaryAction)) : null;
  const secondaryActionMarkup = secondaryAction ? import_react632.default.createElement("div", {
  ...
  const actionMarkup = primaryActionMarkup || secondaryActionMarkup ? import_react632.default.createElement("div", {
    className: actionClassName
  }, import_react632.default.createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup)) : null;
  ...
  return import_react632.default.createElement(Card, null, import_react632.default.createElement("div", {
    className: mediaCardClassName
  }, import_react632.default.createElement("div", {
    className: mediaContainerClassName
  }, children2), import_react632.default.createElement("div", {
    className: infoContainerClassName
  }, import_react632.default.createElement(Card.Section, null, popoverActionsMarkup, import_react632.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, headerMarkup, import_react632.default.createElement("p", {
...
var NavigationContext = (0, import_react633.createContext)({
  location: ""
});
...
function Secondary({
  ...
  return import_react634.default.createElement(Collapsible, {
    id: id || uid,
    open: expanded,
    transition: {
      duration: "0ms",
  ...
  }, import_react634.default.createElement("ul", {
...
function Item8({
  ...
  const {
    location,
    onNavigationDismiss
  } = (0, import_react635.useContext)(NavigationContext);
  const [keyFocused, setKeyFocused] = (0, import_react635.useState)(false);
  ...
  const handleKeyUp = (0, import_react635.useCallback)((event) => {
    if (event.keyCode === Key.Tab) {
      !keyFocused && setKeyFocused(true);
    }
  }, [keyFocused]);
  const handleBlur = (0, import_react635.useCallback)(() => {
  ...
  const indicatorMarkup = hasNewChild ? import_react635.default.createElement("span", {
    className: styles95.Indicator
  }, import_react635.default.createElement(Indicator, {
    pulse: true
  })) : null;
  const iconMarkup = icon ? import_react635.default.createElement("div", {
    className: classNames(styles95.Icon, shouldResizeIcon && styles95["Icon-resized"])
  }, import_react635.default.createElement(Icon, {
    source: icon
  })) : null;
  let badgeMarkup = null;
  if (isNew) {
    badgeMarkup = import_react635.default.createElement(Badge, {
      status: "new",
      size: "small"
  ...
  const wrappedBadgeMarkup = badgeMarkup == null ? null : import_react635.default.createElement("div", {
    className: styles95.Badge
  }, badgeMarkup);
  const itemContentMarkup = import_react635.default.createElement(import_react635.default.Fragment, null, iconMarkup, import_react635.default.createElement("span", {
  ...
  if (url == null) {
    ...
    return import_react635.default.createElement("li", {
      className: styles95.ListItem
    }, import_react635.default.createElement("button", {
      type: "button",
  ...
  const secondaryActionLinkMarkup = secondaryAction && import_react635.default.createElement(UnstyledLink, {
    external: true,
  ...
  const secondaryActionMarkup = secondaryAction && (secondaryAction.tooltip ? import_react635.default.createElement(Tooltip, secondaryAction.tooltip, secondaryActionLinkMarkup) : secondaryActionLinkMarkup);
  ...
  if (subNavigationItems.length > 0) {
    ...
    secondaryNavigationMarkup = import_react635.default.createElement("div", {
      className: SecondaryNavigationClassName
    }, import_react635.default.createElement(Secondary, {
      ...
      return import_react635.default.createElement(Item8, Object.assign({
        key: label2
      }, rest, {
        label: label2,
  ...
  }, import_react635.default.createElement(UnstyledLink, Object.assign({
    url,
...
function Section7({
  ...
  const animationFrame = (0, import_react636.useRef)(null);
  const {
    isNavigationCollapsed
  } = useMediaQuery();
  const [expandedIndex, setExpandedIndex] = (0, import_react636.useState)();
  ...
  const buttonMarkup = action && import_react636.default.createElement("button", {
    type: "button",
  ...
  const actionMarkup = action && (action.tooltip ? import_react636.default.createElement(Tooltip, action.tooltip, buttonMarkup) : buttonMarkup);
  const sectionHeadingMarkup = title && import_react636.default.createElement("li", {
  ...
  const itemsMarkup = items.map((item, index) => {
    ...
    return import_react636.default.createElement(Item8, Object.assign({
      key: label
    }, rest, {
      label,
      subNavigationItems,
  ...
  const toggleRollup = rollup && items.length > rollup.after && import_react636.default.createElement("div", {
    className: styles95.ListItem,
    key: "List Item"
  ...
  const activeItemsMarkup = rollup && additionalItems.length > 0 && import_react636.default.createElement("li", {
    className: styles95.RollupSection
  }, import_react636.default.createElement(Collapsible, {
    id: additionalItemsId,
    open: expanded
  }, import_react636.default.createElement("ul", {
    className: styles95.List
  }, additionalItems)), toggleRollup);
  return import_react636.default.createElement("ul", {
    className
...
var Navigation2 = function Navigation3({
  ...
  const width = getWidth(logo, 104);
  const logoMarkup = logo ? import_react637.default.createElement("div", {
    className: classNames(styles95.LogoContainer, logoSuffix && styles95.hasLogoSuffix)
  }, import_react637.default.createElement(UnstyledLink, {
    url: logo.url || "",
    className: styles95.LogoLink,
    style: {
      width
    }
  }, import_react637.default.createElement(Image, {
  ...
  const mediaMarkup = contextControl ? import_react637.default.createElement("div", {
    className: styles95.ContextControl
  }, contextControl) : logoMarkup;
  const context = (0, import_react637.useMemo)(() => ({
    location,
    onNavigationDismiss: onDismiss
  }), [location, onDismiss]);
  return import_react637.default.createElement(NavigationContext.Provider, {
    value: context
  }, import_react637.default.createElement(WithinContentContext.Provider, {
    value: true
  }, import_react637.default.createElement("nav", {
    className: styles95.Navigation,
    "aria-labelledby": ariaLabelledBy
  }, mediaMarkup, import_react637.default.createElement(Scrollable, {
...
function Checkbox5({
  ...
  const id = useUniqueId("Checkbox", idProp);
  const [keyFocused, setKeyFocused] = (0, import_react638.useState)(false);
...
function Option3({
  ...
  const handleClick = (0, import_react639.useCallback)(() => {
    if (disabled) {
      return;
    }
    onClick(section, index);
  }, [disabled, index, onClick, section]);
  const mediaMarkup = media ? import_react639.default.createElement("div", {
  ...
  const optionMarkup = allowMultiple ? import_react639.default.createElement("label", {
    htmlFor: id,
    className: multiSelectClassName
  }, import_react639.default.createElement("div", {
    className: styles97.Checkbox
  }, import_react639.default.createElement(Checkbox5, {
    id,
    value,
    checked: select,
    active,
    ...
    role: checkBoxRole
  })), mediaMarkup, label) : import_react639.default.createElement("button", {
    id,
    type: "button",
  ...
  const scrollMarkup = active ? import_react639.default.createElement(Scrollable.ScrollTo, null) : null;
  return import_react639.default.createElement("li", {
    key: id,
...
function OptionList({
  ...
  const [normalizedOptions, setNormalizedOptions] = (0, import_react640.useState)(createNormalizedOptions(options, sections, title));
  ...
  const handleClick = (0, import_react640.useCallback)((sectionIndex, optionIndex) => {
  ...
  const optionsMarkup = optionsExist ? normalizedOptions.map(({
    ...
    const titleMarkup = title2 ? import_react640.default.createElement("p", {
    ...
    const optionsMarkup2 = options2 && options2.map((option, optionIndex) => {
      ...
      return import_react640.default.createElement(Option3, Object.assign({
        key: optionId
      }, option, {
        id: optionId,
    ...
    }, titleMarkup, import_react640.default.createElement("ul", {
      className: styles96.Options,
      id: `${id}-${sectionIndex}`,
      role
    }, optionsMarkup2));
  }) : null;
  return import_react640.default.createElement("ul", {
...
function isInterface(x) {
  return !(0, import_react641.isValidElement)(x) && x !== void 0;
}
...
function isReactElement(x) {
  return (0, import_react642.isValidElement)(x) && x !== void 0;
}
...
function Pagination({
  ...
  const i18n = useI18n();
  const node = (0, import_react643.createRef)();
  ...
  const prev = import_react643.default.createElement(Button, {
    outline: true,
    icon: SvgChevronLeftMinor,
  ...
  const constructedPrevious = previousTooltip && hasPrevious ? import_react643.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: previousTooltip
  }, prev) : prev;
  const next = import_react643.default.createElement(Button, {
    outline: true,
    icon: SvgChevronRightMinor,
  ...
  const constructedNext = nextTooltip && hasNext ? import_react643.default.createElement(Tooltip, {
    activatorWrapper: "span",
    content: nextTooltip
  }, next) : next;
  const previousHandler = onPrevious || noop11;
  const previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map((key) => import_react643.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: previousURL ? handleCallback(clickPaginationLink("previousURL", node)) : handleCallback(previousHandler)
  }));
  const nextHandler = onNext || noop11;
  const nextButtonEvents = nextKeys && (nextURL || onNext) && hasNext && nextKeys.map((key) => import_react643.default.createElement(KeypressListener, {
    key,
    keyCode: key,
    handler: nextURL ? handleCallback(clickPaginationLink("nextURL", node)) : handleCallback(nextHandler)
  }));
  const labelTextMarkup = hasNext && hasPrevious ? import_react643.default.createElement(TextStyle, null, label) : import_react643.default.createElement(TextStyle, {
    variation: "subdued"
  }, label);
  const labelMarkup = label ? import_react643.default.createElement("div", {
    "aria-live": "polite"
  }, labelTextMarkup) : null;
  return import_react643.default.createElement("nav", {
    "aria-label": navLabel,
    ref: node
  }, previousButtonEvents, nextButtonEvents, import_react643.default.createElement(ButtonGroup, {
    segmented: !label
...
function Title({
  ...
  const titleMarkup = title ? import_react644.default.createElement("h1", {
    className
  }, title) : null;
  const titleMetadataMarkup = titleMetadata ? import_react644.default.createElement("div", {
    className: styles101.TitleMetadata
  }, titleMetadata) : null;
  const wrappedTitleMarkup = titleMetadata ? import_react644.default.createElement("div", {
    className: styles101.TitleWithMetadataWrapper
  }, titleMarkup, titleMetadataMarkup) : titleMarkup;
  const subtitleMarkup = subtitle ? import_react644.default.createElement("div", {
    className: classNames(styles101.SubTitle, compactTitle && styles101.SubtitleCompact)
  }, import_react644.default.createElement("p", null, subtitle)) : null;
  return import_react644.default.createElement(import_react644.default.Fragment, null, wrappedTitleMarkup, subtitleMarkup);
}
...
function Header4({
  ...
  const breadcrumbMarkup = breadcrumbs.length > 0 ? import_react645.default.createElement("div", {
    className: styles100.BreadcrumbWrapper
  }, import_react645.default.createElement(Breadcrumbs, {
    breadcrumbs
  })) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? import_react645.default.createElement("div", {
    className: styles100.PaginationWrapper
  }, import_react645.default.createElement(Pagination, pagination)) : null;
  const additionalNavigationMarkup = additionalNavigation ? import_react645.default.createElement("div", {
    className: styles100.AdditionalNavigationWrapper
  }, additionalNavigation) : null;
  const navigationMarkup = breadcrumbMarkup || paginationMarkup || additionalNavigationMarkup ? import_react645.default.createElement("div", {
    className: styles100.Navigation
  }, breadcrumbMarkup, additionalNavigationMarkup, paginationMarkup) : null;
  const pageTitleMarkup = import_react645.default.createElement("div", {
    className: styles100.TitleWrapper
  }, import_react645.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle
  }));
  const primaryActionMarkup = primaryAction ? import_react645.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = import_react645.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = import_react645.default.createElement(import_react645.default.Fragment, null, secondaryActions);
  }
  const additionalMetadataMarkup = additionalMetadata ? import_react645.default.createElement("div", {
    className: styles100.AdditionalMetaData
  }, import_react645.default.createElement(TextStyle, {
    variation: "subdued"
  ...
  }, import_react645.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, import_react645.default.createElement("div", {
    className: styles100.Row
  }, slot1, slot2, import_react645.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, import_react645.default.createElement("div", {
    className: styles100.RightAlign
  }, import_react645.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children2) => import_react645.default.createElement("div", {
      className: styles100.Actions
    }, children2)
  }, slot3, slot4))))), import_react645.default.createElement(ConditionalRender, {
    condition: [slot5, slot6].some(notNull)
  }, import_react645.default.createElement("div", {
    className: styles100.Row
  }, import_react645.default.createElement("div", {
    className: styles100.LeftAlign
  }, slot5), import_react645.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? import_react645.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  }
  return import_react645.default.createElement("div", {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: import_react645.default.createElement(import_react645.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? import_react646.default.createElement(Header4, rest) : null;
  return import_react646.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, import_react646.default.createElement("div", {
...
function PageActions({
  ...
  if (isReactElement(primaryAction)) {
    primaryActionMarkup = import_react647.default.createElement(import_react647.default.Fragment, null, primaryAction);
  ...
  if (isInterface(secondaryActions) && secondaryActions.length > 0) {
    secondaryActionsMarkup = import_react647.default.createElement(ButtonGroup, null, buttonsFrom(secondaryActions));
  } else if (isReactElement(secondaryActions)) {
    secondaryActionsMarkup = import_react647.default.createElement(import_react647.default.Fragment, null, secondaryActions);
  }
  ...
  }, import_react647.default.createElement(Stack, {
    distribution,
    spacing: "tight"
...
function PolarisTestProvider({
  ...
  const Wrapper = strict ? import_react648.StrictMode : import_react648.Fragment;
  const intl = (0, import_react648.useMemo)(() => new I18n(i18n || {}), [i18n]);
  const scrollLockManager = (0, import_react648.useMemo)(() => new ScrollLockManager(), []);
  const stickyManager = (0, import_react648.useMemo)(() => new StickyManager(), []);
  const uniqueIdFactory = (0, import_react648.useMemo)(() => new UniqueIdFactory(globalIdGeneratorFactory), []);
  const mergedFrame = createFrameContext(frame);
  const mergedMediaQuery = merge(defaultMediaQuery, mediaQuery);
  return import_react648.default.createElement(Wrapper, null, import_react648.default.createElement(FeaturesContext.Provider, {
    value: features
  }, import_react648.default.createElement(I18nContext.Provider, {
    value: intl
  }, import_react648.default.createElement(ScrollLockManagerContext.Provider, {
    value: scrollLockManager
  }, import_react648.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager
  }, import_react648.default.createElement(UniqueIdFactoryContext.Provider, {
    value: uniqueIdFactory
  }, import_react648.default.createElement(LinkContext.Provider, {
    value: link
  }, import_react648.default.createElement(CustomProperties, {
    colorScheme
  }, import_react648.default.createElement(MediaQueryContext.Provider, {
    value: mergedMediaQuery
  }, import_react648.default.createElement(PortalsManager, null, import_react648.default.createElement(FocusManager, null, import_react648.default.createElement(FrameContext.Provider, {
    value: mergedFrame
  }, children2))))))))))));
}
function noop12() {
...
function ProgressBar({
  ...
  return import_react649.default.createElement("div", {
    className
  }, import_react649.default.createElement("progress", {
    className: styles103.Progress,
    value: parsedProgress,
    max: "100"
  }), import_react649.default.createElement(CSSTransition_default, {
    in: true,
    appear: true,
...
var DualThumb = class extends import_react650.Component {
  constructor(...args) {
    super(...args);
    this.context = void 0;
    this.state = {
    ...
    this.track = (0, import_react650.createRef)();
    this.trackWrapper = (0, import_react650.createRef)();
    this.thumbLower = (0, import_react650.createRef)();
    this.thumbUpper = (0, import_react650.createRef)();
  ...
  render() {
    ...
    const outputMarkupLower = !disabled && output ? import_react650.default.createElement("output", {
      htmlFor: idLower,
    ...
    }, import_react650.default.createElement("span", {
      className: styles104.OutputText
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles104.Output, styles104.OutputUpper);
    const outputMarkupUpper = !disabled && output ? import_react650.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && import_react650.default.createElement("div", {
      className: styles104.Prefix
    }, prefix);
    const suffixMarkup = suffix && import_react650.default.createElement("div", {
      className: styles104.Suffix
    }, suffix);
    return import_react650.default.createElement(import_react650.default.Fragment, null, import_react650.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
    ...
    }, prefixMarkup, import_react650.default.createElement("div", {
      ...
      ref: this.thumbLower
    }), outputMarkupLower, import_react650.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), import_react650.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && import_react651.default.createElement("output", {
    htmlFor: id,
    className: styles105.Output
  }, import_react651.default.createElement("div", {
    className: styles105.OutputBubble
  }, import_react651.default.createElement("span", {
    className: styles105.OutputText
  }, clampedValue)));
  const prefixMarkup = prefix && import_react651.default.createElement("div", {
    className: styles105.Prefix
  }, prefix);
  const suffixMarkup = suffix && import_react651.default.createElement("div", {
  ...
  return import_react651.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, import_react651.default.createElement("div", {
    className: styles105.InputWrapper
  }, import_react651.default.createElement("input", {
    type: "range",
...
function RangeSlider({
  ...
  return isDualThumb(value) ? import_react652.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : import_react652.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
var BaseResourceItem = class extends import_react653.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.buttonOverlay = (0, import_react653.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    if (selectable) {
      ...
      }, import_react653.default.createElement(Checkbox, {
        id: this.checkboxId,
    ...
    if (media || selectable) {
      ownedMarkup = import_react653.default.createElement("div", {
    ...
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = import_react653.default.createElement("div", {
          className: styles106.Actions,
          onClick: stopPropagation2
        }, import_react653.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          plain: true
        })));
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = import_react653.default.createElement("div", {
          className: styles106.Disclosure,
          onClick: stopPropagation2
        }, import_react653.default.createElement(Popover2, {
          activator: import_react653.default.createElement(Button, {
        ...
        }, import_react653.default.createElement(ActionList, {
        ...
        actionsMarkup = import_react653.default.createElement("div", {
          className: styles106.Actions,
          onClick: stopPropagation2
        }, import_react653.default.createElement(ButtonGroup, {
          segmented: true
    ...
    const content = children2 ? import_react653.default.createElement("div", {
    ...
    const containerMarkup = import_react653.default.createElement("div", {
      className: containerClassName,
      id: this.props.id
    ...
    const accessibleMarkup = url ? import_react653.default.createElement(UnstyledLink, {
      ...
      tabIndex,
      id: this.overlayId
    }) : import_react653.default.createElement("button", {
    ...
    return import_react653.default.createElement("li", {
...
function ResourceItem(props) {
  return import_react653.default.createElement(BaseResourceItem, Object.assign({}, props, {
    context: (0, import_react653.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react654.useRef)(UNIQUE_IDENTIFIER);
...
function Select({
  ...
  const inlineLabelMarkup = labelInline && import_react655.default.createElement("span", {
    className: styles108.InlineLabel
  }, label);
  const selectedOption = getSelectedOption(normalizedOptions, value);
  const prefixMarkup = selectedOption.prefix && import_react655.default.createElement("div", {
    className: styles108.Prefix
  }, selectedOption.prefix);
  const contentMarkup = import_react655.default.createElement("div", {
    className: styles108.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, import_react655.default.createElement("span", {
    className: styles108.SelectedOption
  }, selectedOption.label), import_react655.default.createElement("span", {
    className: styles108.Icon
  }, import_react655.default.createElement(Icon, {
    source: SvgSelectMinor
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return import_react655.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className
  }, import_react655.default.createElement("select", {
    id,
    name,
    value,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, import_react655.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return import_react655.default.createElement("option", Object.assign({
    key: value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return import_react655.default.createElement("optgroup", {
      label: title,
      key: title
...
var ResourceList = function ResourceList2({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react656.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react656.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react656.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react656.useState)(isSmallScreen2());
  const forceUpdate = (0, import_react656.useReducer)((x = 0) => x + 1, 0)[1];
  const [checkableButtons, setCheckableButtons] = (0, import_react656.useState)(/* @__PURE__ */ new Map());
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react656.useRef)(null);
  ...
  const setLoadingPosition = (0, import_react656.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? import_react656.default.createElement("div", {
    className: styles107.BulkActionsWrapper
  }, import_react656.default.createElement(BulkActions, {
  ...
  const filterControlMarkup = filterControl ? import_react656.default.createElement("div", {
    className: styles107.FiltersWrapper
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? import_react656.default.createElement("div", {
    className: styles107.SortWrapper
  }, import_react656.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? import_react656.default.createElement("div", {
    className: styles107.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = import_react656.default.createElement("div", {
    className: styles107.HeaderTitleWrapper
  }, headerTitle());
  const selectButtonMarkup = isSelectable ? import_react656.default.createElement("div", {
    className: styles107.SelectButtonWrapper
  }, import_react656.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgEnableSelectionMinor,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? import_react656.default.createElement("div", {
    className: styles107.CheckableButtonWrapper
  }, import_react656.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel(),
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    plain: true,
  ...
  const headerWrapperOverlay = loading ? import_react656.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && import_react656.default.createElement("div", {
    className: styles107.HeaderOuterWrapper
  }, import_react656.default.createElement(Sticky, {
    ...
    return import_react656.default.createElement("div", {
      className: headerClassName
    }, import_react656.default.createElement(EventListener, {
      event: "resize",
      handler: handleResize
    }), headerWrapperOverlay, import_react656.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || import_react656.default.createElement("div", {
    className: styles107.EmptySearchResultWrapper
  }, import_react656.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
    withIllustration: true
  }))) : null;
  ...
  const loadingOverlay = loading ? import_react656.default.createElement(import_react656.default.Fragment, null, import_react656.default.createElement("li", {
    className: styles107.SpinnerContainer,
    style: spinnerStyle
  }, import_react656.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), import_react656.default.createElement("li", {
  ...
  const loadingWithoutItemsMarkup = loading && !itemsExist ? import_react656.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? import_react656.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react656.Children.toArray(items.map(renderItemWithId))) : null;
  const context = {
  ...
  return import_react656.default.createElement(ResourceListContext.Provider, {
    value: context
...
function SettingToggle({
  ...
  const id = (0, import_react657.useMemo)(getUniqueSettingToggleId, []);
  ...
  return import_react657.default.createElement(Card, {
    sectioned: true
  }, import_react657.default.createElement(SettingAction, {
    action: actionMarkup
  }, import_react657.default.createElement("label", {
    htmlFor: id
  }, children2)));
}
...
function SkeletonBodyText({
  ...
  for (let i = 0; i < lines; i++) {
    bodyTextLines.push(import_react658.default.createElement("div", {
      className: styles109.SkeletonBodyText,
      key: i
    }));
  }
  return import_react658.default.createElement(import_react658.default.Fragment, null, bodyTextLines);
}
...
function SkeletonPage({
  ...
  const titleContent = title ? import_react660.default.createElement("h1", {
    className: styles111.Title
  }, title) : import_react660.default.createElement("div", {
    className: styles111.SkeletonTitle
  });
  const titleMarkup = import_react660.default.createElement("div", {
    className: styles111.TitleWrapper
  }, titleContent);
  const primaryActionMarkup = primaryAction ? import_react660.default.createElement("div", {
    className: styles111.PrimaryAction
  }, import_react660.default.createElement(SkeletonDisplayText, {
    size: "large"
  })) : null;
  const breadcrumbMarkup = breadcrumbs ? import_react660.default.createElement("div", {
    className: styles111.BreadcrumbAction,
    style: {
      width: 60
    }
  }, import_react660.default.createElement(SkeletonBodyText, {
    lines: 1
  })) : null;
  ...
  }, breadcrumbMarkup, import_react660.default.createElement("div", {
    className: styles111.TitleAndPrimaryAction
  }, titleMarkup, primaryActionMarkup)), import_react660.default.createElement("div", {
...
function SkeletonTabs({
  ...
  return import_react661.default.createElement("div", {
    ...
    }, import_react661.default.createElement(SkeletonBodyText, {
      lines: 1
    }));
  }));
}
...
function Panel({
  ...
  return import_react663.default.createElement("div", {
    className,
    id,
    role: "tabpanel",
...
function Tab({
  ...
  const wasSelected = (0, import_react664.useRef)(selected);
  const panelFocused = (0, import_react664.useRef)(false);
  const node = (0, import_react664.useRef)(null);
  (0, import_react664.useEffect)(() => {
    if (measuring) {
      return;
    }
  ...
  const markup = url ? import_react664.default.createElement(UnstyledLink, {
    id,
    url,
    role: "tab",
    tabIndex,
  ...
  }, children2)) : import_react664.default.createElement("button", {
    id,
    role: "tab",
    type: "button",
    tabIndex,
  ...
  return import_react664.default.createElement("li", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/components/TabMeasurer/TabMeasurer.js
var TabMeasurer = (0, import_react665.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react665.useRef)(null);
  const animationFrame = (0, import_react665.useRef)(null);
  const handleMeasurement = (0, import_react665.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return import_react665.default.createElement(Tab, {
      measuring: true,
  ...
  return import_react665.default.createElement("div", {
    className: classname,
    ref: containerNode
  }, import_react665.default.createElement(EventListener, {
    event: "resize",
...
var Item9 = class extends import_react666.PureComponent {
  constructor(...args) {
    super(...args);
    this.context = void 0;
  ...
  render() {
    ...
    const markup = url ? import_react666.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
      url
    }), children2) : import_react666.default.createElement("button", Object.assign({}, sharedProps, {
      type: "button"
    }), children2);
    return import_react666.default.createElement("li", null, markup);
  }
};
...
function List3({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return import_react667.default.createElement(Item9, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return import_react667.default.createElement("ul", {
...
// node_modules/@shopify/polaris/build/esm/components/Tabs/Tabs.js
var TabsInner = class extends import_react668.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      disclosureWidth: 0,
    ...
    this.renderTabMarkup = (tab, index) => {
      ...
      return import_react668.default.createElement(Tab, {
        key: `${index}-${tab.id}`,
        id: tab.id,
  ...
  render() {
    ...
    const panelMarkup = children2 ? tabs.map((_tab, index) => {
      return selected === index ? import_react668.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id
      }, children2) : import_react668.default.createElement(Panel, {
        id: tabs[index].panelID || `${tabs[index].id}-panel`,
        tabID: tabs[index].id,
        key: tabs[index].id,
        hidden: true
    ...
    const disclosureButtonContent = hasCustomDisclosure ? import_react668.default.createElement(import_react668.default.Fragment, null, disclosureText, import_react668.default.createElement(Icon, {
      source: SvgCaretDownMinor,
      color: "subdued"
    })) : import_react668.default.createElement(Icon, {
      source: SvgHorizontalDotsMinor,
      color: "subdued"
    });
    const disclosureButton = import_react668.default.createElement("button", {
      type: "button",
      className: disclosureButtonClassName,
      onClick: this.handleDisclosureActivatorClick,
      "aria-label": i18n.translate("Polaris.Tabs.toggleTabsLabel")
    }, import_react668.default.createElement("span", {
      className: disclosureButtonContentWrapperClassName
    }, disclosureButtonContent));
    const activator = disclosureText ? import_react668.default.createElement("div", {
      className: styles114.TabContainer
    }, disclosureButton) : disclosureButton;
    return import_react668.default.createElement("div", null, import_react668.default.createElement("div", {
      className: styles114.Wrapper
    }, import_react668.default.createElement(TabMeasurer, {
      tabToFocus,
      activator,
      selected,
      tabs,
      siblingTabHasFocus: tabToFocus > -1,
      handleMeasurement: this.handleMeasurement
    }), import_react668.default.createElement("ul", {
      role: "tablist",
      className: classname,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
    ...
    }, tabsMarkup, import_react668.default.createElement("li", {
    ...
    }, import_react668.default.createElement(List3, {
...
function Tabs(props) {
  const i18n = useI18n();
  return import_react668.default.createElement(TabsInner, Object.assign({}, props, {
    i18n
  }));
}
...
function Thumbnail({
  ...
  const content = typeof source === "string" ? import_react669.default.createElement(Image, {
    alt,
    source
  }) : import_react669.default.createElement(Icon, {
    accessibilityLabel: alt,
    source
  });
  return import_react669.default.createElement("span", {
    className
  }, content);
}
...
var Toast2 = (0, import_react670.memo)(function Toast3(props) {
...
function SearchDismissOverlay({
  ...
  const handleDismiss = (0, import_react671.useCallback)(({
    target
  }) => {
  ...
  return import_react671.default.createElement(import_react671.default.Fragment, null, visible ? import_react671.default.createElement(ScrollLock, null) : null, import_react671.default.createElement("div", {
    ref: node,
...
function Search({
  ...
  const overlayMarkup = visible ? import_react672.default.createElement(SearchDismissOverlay, {
    onDismiss,
    visible: overlayVisible
  }) : null;
  return import_react672.default.createElement(import_react672.default.Fragment, null, overlayMarkup, import_react672.default.createElement("div", {
    className: classNames(styles117.Search, visible && styles117.visible)
  }, import_react672.default.createElement(CustomProperties, {
    colorScheme: "dark"
  }, import_react672.default.createElement("div", {
...
function SearchField({
  ...
  const i18n = useI18n();
  const [forceActive, setForceActive] = (0, import_react673.useState)(false);
  const input = (0, import_react673.useRef)(null);
  const searchId = useUniqueId("SearchField");
  const handleChange = (0, import_react673.useCallback)(({
    currentTarget
  }) => {
    onChange(currentTarget.value);
  }, [onChange]);
  const handleFocus = (0, import_react673.useCallback)(() => onFocus && onFocus(), [onFocus]);
  const handleBlur = (0, import_react673.useCallback)(() => onBlur && onBlur(), [onBlur]);
  const handleClear = (0, import_react673.useCallback)(() => {
    onCancel && onCancel();
    if (!input.current) {
      return;
    }
  ...
  const clearMarkup = value !== "" && import_react673.default.createElement("button", {
    type: "button",
  ...
  }, import_react673.default.createElement(Icon, {
    source: SvgCircleCancelMinor
  }));
  const className = classNames(styles119.SearchField, (focused || active || forceActive) && styles119.focused);
  return import_react673.default.createElement("div", {
    className,
    onFocus: handleFocus,
    onBlur: handleBlur
  }, import_react673.default.createElement(VisuallyHidden, null, import_react673.default.createElement("label", {
    htmlFor: searchId
  }, i18n.translate("Polaris.TopBar.SearchField.search"))), import_react673.default.createElement("input", {
    id: searchId,
  ...
  }), import_react673.default.createElement("span", {
    className: styles119.Icon
  }, import_react673.default.createElement(Icon, {
    source: SvgSearchMinor
  })), clearMarkup, import_react673.default.createElement("div", {
...
function MessageIndicator({
  ...
  const indicatorMarkup = active && import_react674.default.createElement("div", {
...
function Message({
  ...
  const badgeMarkup = badge && import_react675.default.createElement(Badge, {
    status: badge.status
  }, badge.content);
  const {
    to,
  ...
  }, import_react675.default.createElement(Popover2.Section, null, import_react675.default.createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, import_react675.default.createElement(TextContainer, null, import_react675.default.createElement(Heading, null, title, badgeMarkup), import_react675.default.createElement("p", null, description)), import_react675.default.createElement(Link, {
    url: to
  }, linkContent), import_react675.default.createElement(Button, {
    plain: true,
    onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  const messageMarkup = message && import_react676.default.createElement(Message, {
    title: message.title,
  ...
  return import_react676.default.createElement(Popover2, {
    activator: import_react676.default.createElement("div", {
      className: styles122.ActivatorWrapper
    }, import_react676.default.createElement("button", {
      type: "button",
    ...
    preferredAlignment: "right",
    colorScheme
  }, import_react676.default.createElement(ActionList, {
...
function UserMenu({
  ...
  const activatorContentMarkup = import_react677.default.createElement(import_react677.default.Fragment, null, import_react677.default.createElement(MessageIndicator, {
    active: showIndicator
  }, import_react677.default.createElement(Avatar, {
    size: "small",
    source: avatar,
    initials: initials && initials.replace(" ", "")
  })), import_react677.default.createElement("span", {
    className: styles120.Details
  }, import_react677.default.createElement("p", {
    className: styles120.Name
  }, name), import_react677.default.createElement("p", {
  ...
  return import_react677.default.createElement(Menu, {
...
var TopBar = function TopBar2({
  ...
  const navigationButtonMarkup = showNavigationToggle ? import_react678.default.createElement("button", {
    type: "button",
    className: iconClassName,
  ...
  }, import_react678.default.createElement("div", {
    className: styles116.IconWrapper
  }, import_react678.default.createElement(Icon, {
    source: SvgMobileHamburgerMajor
  }))) : null;
  const width = getWidth(logo, 104);
  let contextMarkup;
  if (contextControl) {
    contextMarkup = import_react678.default.createElement("div", {
    ...
    contextMarkup = import_react678.default.createElement("div", {
      className
    }, import_react678.default.createElement(UnstyledLink, {
      url: logo.url || "",
      className: styles116.LogoLink,
      style: {
        width
      }
    }, import_react678.default.createElement(Image, {
      source: logo.topBarSource || "",
      alt: logo.accessibilityLabel || "",
  ...
  const searchMarkup = searchField ? import_react678.default.createElement(import_react678.default.Fragment, null, searchField, import_react678.default.createElement(Search, {
  ...
  }, navigationButtonMarkup, contextMarkup, import_react678.default.createElement("div", {
    className: styles116.Contents
  }, import_react678.default.createElement("div", {
    className: styles116.SearchField
  }, searchMarkup), import_react678.default.createElement("div", {
...
function VideoThumbnail({
  ...
  const timeStampMarkup = videoLength ? import_react679.default.createElement("p", {
  ...
  if (showVideoProgress) {
    ...
    progressMarkup = import_react679.default.createElement("div", {
      className: styles124.Progress
    }, import_react679.default.createElement("progress", {
      className: styles124.ProgressBar,
      value: progressValuePercents,
      max: "100"
    }), import_react679.default.createElement("div", {
  ...
  return import_react679.default.createElement("div", {
    className: styles124.Thumbnail,
    style: {
      backgroundImage: `url(${thumbnailUrl})`
    }
  }, import_react679.default.createElement("button", {
    type: "button",
  ...
  }, import_react679.default.createElement("img", {
...
function useRowHovered() {
  const hovered = (0, import_react680.useContext)(RowHoveredContext);
  return hovered;
}
function useRowSelected() {
  const {
    selected
  } = (0, import_react680.useContext)(RowContext);
  return selected;
}
function useContainerScroll() {
  const scrolledContainerRef = (0, import_react680.useContext)(ScrollContext);
