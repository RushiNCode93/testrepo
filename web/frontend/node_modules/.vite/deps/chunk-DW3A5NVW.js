...
function getCustomPropertyNames(tokens2) {
  var colorSchemes2 = tokens2.colorSchemes, restTokenGroups = _objectWithoutProperties(tokens2, _excluded);
  var customPropertyNames = [].concat(_toConsumableArray(Object.keys(colorSchemes2.light).map(function(token) {
...
//# sourceMappingURL=chunk-DW3A5NVW.js.map
