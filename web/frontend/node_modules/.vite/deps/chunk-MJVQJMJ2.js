import {
  ...
  require_Modal,
  require_Modal2,
  require_SessionToken2 as require_SessionToken,
  ...
  "node_modules/web-vitals/dist/web-vitals.umd.cjs"(exports, module) {
    !function(e, n) {
      ...
      var n, t, i, r, o, a = -1, c = function(e2) {
        ...
        return a >= 0 ? i2 = "back-forward-cache" : t2 && (i2 = document.prerendering || s() > 0 ? "prerender" : document.wasDiscarded ? "restore" : t2.type.replace(/_/g, "-")), { name: e2, value: void 0 === n2 ? -1 : n2, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: i2 };
      }, d = function(e2, n2, t2) {
        try {
      ...
      }, F = { passive: true, capture: true }, I = new Date(), A = function(e2, r2) {
        n || (n = r2, t = e2, i = new Date(), k(removeEventListener), M());
      }, M = function() {
        if (t >= 0 && t < i - I) {
...
//# sourceMappingURL=chunk-MJVQJMJ2.js.map
