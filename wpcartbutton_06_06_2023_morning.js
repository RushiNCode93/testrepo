...
/*fetch('https://enemies-decision-optimize-seas.trycloudflare.com/api/get-saved-form-data')
...
/*
  ...
  fetch('https://enemies-decision-optimize-seas.trycloudflare.com/api/get-cart-url')
  .then(response => response.json())
  .then(formData => {
...
/*function getCartItems() {  
  return fetch('https://enemies-decision-optimize-seas.trycloudflare.com/api/get-cart-url')
    .then(response => response.json())
    .then(cartData => {
...
fetch('https://enemies-decision-optimize-seas.trycloudflare.com/api/get-cart-url')
  ...
  .then(cartData => {
    // Fetch the form data
    return fetch('https://enemies-decision-optimize-seas.trycloudflare.com/api/get-saved-form-data')
      .then(response => response.json())
      .then(formData => {
        // Access the form values from the response
        const selected = formData[0].wp_cart_enable_disable;
