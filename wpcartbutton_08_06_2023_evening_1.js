...
/*fetch('https://jpeg-notes-tips-many.trycloudflare.com/api/get-saved-form-data')
...
/*function getCartItems() {  
  return fetch('https://jpeg-notes-tips-many.trycloudflare.com/api/get-cart-url')
    .then(response => response.json())
    .then(cartData => {
      ...
      .then(formData => {
        ...
        fetch('https://ncodeshop.myshopify.com/cart.js')
          ...
          .then(data => {
            ...
            whatsappButton.innerText =  blt;
            whatsappButton.style.backgroundColor = '#006E52';
            whatsappButton.style.color = '#fff';
            //whatsappButton.style.marginLeft = '10px';
