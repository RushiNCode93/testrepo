        ...
        fetch('https://ncodeshop.myshopify.com/cart.js')
          ...
          .then(data => {          
            ...
            customButton.addEventListener('click', function() {
              ...
              //Original Code Whatsapp Share URL
              ...
              const longUrl     = 'https://api.whatsapp.com/send?text=' + encodeURIComponent(message) + '&redirect=false';
              ...
              fetch('https://api-ssl.bitly.com/v4/shorten', {
                ...
                .then(bitlyResponse => {
                  if (bitlyResponse && bitlyResponse.link) {
                    ...
                    var whatsappUrl = 'https://api.whatsapp.com/send?text=' + encodeURIComponent(shortLink) + '&redirect=false';
                    window.open(whatsappUrl, '_blank');
                  } else {
